...
const file_contrib_envoy_extensions_matching_input_matchers_hyperscan_v3alpha_hyperscan_proto_rawDesc = "" +
	...
	"\x05quiet\x18\n" +
	" \x01(\bR\x05quietB\xdf\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Hio.envoyproxy.envoy.extensions.matching.input_matchers.hyperscan.v3alphaB\x0eHyperscanProtoP\x01Zygithub.com/CloudNativeWorks/versioned-go-control-plane/contrib/envoy/extensions/matching/input_matchers/hyperscan/v3alphab\x06proto3"
