...
import (
	...
	v3 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/common/key_value/v3"
...
const file_contrib_envoy_extensions_config_v3alpha_kv_store_xds_delegate_config_proto_rawDesc = "" +
	...
	"\x16key_value_store_config\x18\x01 \x01(\v25.envoy.config.common.key_value.v3.KeyValueStoreConfigR\x13keyValueStoreConfigB\xb8\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"-io.envoyproxy.envoy.extensions.config.v3alphaB\x1dKvStoreXdsDelegateConfigProtoP\x01Z^github.com/CloudNativeWorks/versioned-go-control-plane/contrib/envoy/extensions/config/v3alphab\x06proto3"
