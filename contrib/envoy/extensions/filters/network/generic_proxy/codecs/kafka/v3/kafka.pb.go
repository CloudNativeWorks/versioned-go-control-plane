...
const file_contrib_envoy_extensions_filters_network_generic_proxy_codecs_kafka_v3_kafka_proto_rawDesc = "" +
	...
	"\x10KafkaCodecConfigB\xf4\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\xd2Ƥ\xe1\x06\x02\b\x01\n" +
	"Lio.envoyproxy.envoy.extensions.filters.network.generic_proxy.codecs.kafka.v3B\n" +
	"KafkaProtoP\x01Z\x85\x01github.com/CloudNativeWorks/versioned-go-control-plane/contrib/envoy/extensions/filters/network/generic_proxy/codecs/kafka/v3;kafkav3b\x06proto3"
