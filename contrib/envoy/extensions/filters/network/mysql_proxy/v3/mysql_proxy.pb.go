...
const file_contrib_envoy_extensions_filters_network_mysql_proxy_v3_mysql_proxy_proto_rawDesc = "" +
	...
	";envoy.config.filter.network.mysql_proxy.v1alpha1.MySQLProxyB\xd8\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"=io.envoyproxy.envoy.extensions.filters.network.mysql_proxy.v3B\x0fMysqlProxyProtoP\x01Z|github.com/CloudNativeWorks/versioned-go-control-plane/contrib/envoy/extensions/filters/network/mysql_proxy/v3;mysql_proxyv3b\x06proto3"
