...
const file_contrib_envoy_extensions_filters_network_sip_proxy_v3alpha_route_proto_rawDesc = "" +
	...
	"\x11cluster_specifier\x12\x03\xf8B\x01B\xcb\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"@io.envoyproxy.envoy.extensions.filters.network.sip_proxy.v3alphaB\n" +
	"RouteProtoP\x01Zqgithub.com/CloudNativeWorks/versioned-go-control-plane/contrib/envoy/extensions/filters/network/sip_proxy/v3alphab\x06proto3"
