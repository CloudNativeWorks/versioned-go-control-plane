...
const file_contrib_envoy_extensions_filters_network_sip_proxy_tra_v3alpha_tra_proto_rawDesc = "" +
	...
	"\tSubscribe\x12I.envoy.extensions.filters.network.sip_proxy.tra.v3alpha.TraServiceRequest\x1aJ.envoy.extensions.filters.network.sip_proxy.tra.v3alpha.TraServiceResponse\"\x000\x01B\xd1\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Dio.envoyproxy.envoy.extensions.filters.network.sip_proxy.tra.v3alphaB\bTraProtoP\x01Zugithub.com/CloudNativeWorks/versioned-go-control-plane/contrib/envoy/extensions/filters/network/sip_proxy/tra/v3alphab\x06proto3"
