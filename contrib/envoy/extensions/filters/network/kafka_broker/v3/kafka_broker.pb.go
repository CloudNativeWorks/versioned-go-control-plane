...
const file_contrib_envoy_extensions_filters_network_kafka_broker_v3_kafka_broker_proto_rawDesc = "" +
	...
	"\x04port\x18\x03 \x01(\rB\t\xfaB\x06*\x04\x18\xff\xff\x03R\x04portB\xdc\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	">io.envoyproxy.envoy.extensions.filters.network.kafka_broker.v3B\x10KafkaBrokerProtoP\x01Z~github.com/CloudNativeWorks/versioned-go-control-plane/contrib/envoy/extensions/filters/network/kafka_broker/v3;kafka_brokerv3b\x06proto3"
