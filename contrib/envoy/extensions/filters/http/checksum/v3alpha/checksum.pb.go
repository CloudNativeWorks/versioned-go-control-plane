...
const file_contrib_envoy_extensions_filters_http_checksum_v3alpha_checksum_proto_rawDesc = "" +
	...
	"<io.envoyproxy.envoy.extensions.filters.http.checksum.v3alphaB\rChecksumProtoP\x01Z]github.com/CloudNativeWorks/versioned-go-control-plane/contrib/envoy/extensions/filters/http/checksum/v3alphab\x06proto3"
