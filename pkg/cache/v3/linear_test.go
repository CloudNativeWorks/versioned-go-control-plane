...
func TestLinearSotwNonWildcard(t *testing.T) {
	...
	t.Run("type not returning full state", func(t *testing.T) {
		...
		// Watch 2, wildcard, starting with no version (https://github.com/CloudNativeWorks/versioned-go-control-plane/issues/855)
		...
		checkPendingWatch(3)
		// Add a resource to watch 4 (https://github.com/CloudNativeWorks/versioned-go-control-plane/issues/608)
	...
	t.Run("type returning full state", func(t *testing.T) {
		...
		c3 := createWatchWithCancel(3)
		checkPendingWatch(3)
		// Add a resource to req4 (https://github.com/CloudNativeWorks/versioned-go-control-plane/issues/608)
		updateReqResources(4, []string{"c", "d"})
		createWatch(4)
