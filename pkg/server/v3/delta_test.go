...
import (
	...
	rsrc "github.com/CloudNativeWorks/versioned-go-control-plane/pkg/resource/v3"
...
func TestDeltaMultipleStreams(t *testing.T) {
	// Unit test for issue identified in https://github.com/CloudNativeWorks/versioned-go-control-plane/issues/913
