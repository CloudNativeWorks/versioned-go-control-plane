...
const file_envoy_api_v2_ratelimit_ratelimit_proto_rawDesc = "" +
	...
	"$io.envoyproxy.envoy.api.v2.ratelimitB\x0eRatelimitProtoP\x01Z=github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/ratelimitb\x06proto3"
