...
const file_envoy_api_v2_cluster_outlier_detection_proto_rawDesc = "" +
	...
	"!failure_percentage_request_volume\x18\x14 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x1efailurePercentageRequestVolumeB\xe6\x01\xf2\x98\xfe\x8f\x05\x19\x12\x17envoy.config.cluster.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\"io.envoyproxy.envoy.api.v2.clusterB\x15OutlierDetectionProtoP\x01ZKgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/cluster\xaa\x02\x16Envoy.Api.V2.ClusterNS\xea\x02\x19Envoy::Api::V2::ClusterNSb\x06proto3"
