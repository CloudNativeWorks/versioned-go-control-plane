...
const file_envoy_api_v2_endpoint_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x1f.envoy.api.v2.endpoint.EndpointR\x05value:\x028\x01B\xa0\x01\xf2\x98\xfe\x8f\x05\x1a\x12\x18envoy.config.endpoint.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1aio.envoyproxy.envoy.api.v2B\rEndpointProtoP\x01ZIgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2;apiv2b\x06proto3"
