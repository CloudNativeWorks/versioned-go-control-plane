...
const file_envoy_api_v2_core_config_source_proto_rawDesc = "" +
	...
	"\x02V3\x10\x02B\xa4\x01\xf2\x98\xfe\x8f\x05\x16\x12\x14envoy.config.core.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1fio.envoyproxy.envoy.api.v2.coreB\x11ConfigSourceProtoP\x01ZHgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/coreb\x06proto3"
