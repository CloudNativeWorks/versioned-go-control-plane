...
const file_envoy_api_v2_core_protocol_proto_rawDesc = "" +
	...
	"\x16http2_protocol_options\x18\x01 \x01(\v2'.envoy.api.v2.core.Http2ProtocolOptionsR\x14http2ProtocolOptionsB\xa0\x01\xf2\x98\xfe\x8f\x05\x16\x12\x14envoy.config.core.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1fio.envoyproxy.envoy.api.v2.coreB\rProtocolProtoP\x01ZHgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/coreb\x06proto3"
