...
const file_envoy_api_v2_core_address_proto_rawDesc = "" +
	...
	"\n" +
	"prefix_len\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueB\b\xfaB\x05*\x03\x18\x80\x01R\tprefixLenB\x9f\x01\xf2\x98\xfe\x8f\x05\x16\x12\x14envoy.config.core.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1fio.envoyproxy.envoy.api.v2.coreB\fAddressProtoP\x01ZHgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/coreb\x06proto3"
