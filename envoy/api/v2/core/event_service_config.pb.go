...
const file_envoy_api_v2_core_event_service_config_proto_rawDesc = "" +
	...
	"\x1fio.envoyproxy.envoy.api.v2.coreB\x17EventServiceConfigProtoP\x01Z8github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/coreb\x06proto3"
