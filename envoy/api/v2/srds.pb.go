...
const file_envoy_api_v2_srds_proto_rawDesc = "" +
	...
	"%envoy.api.v2.ScopedRouteConfigurationB\x9a\x01\xf2\x98\xfe\x8f\x05\x18\x12\x16envoy.service.route.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1aio.envoyproxy.envoy.api.v2B\tSrdsProtoP\x01ZIgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2;apiv2P\x05b\x06proto3"
