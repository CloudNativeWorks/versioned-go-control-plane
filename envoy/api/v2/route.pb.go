...
const file_envoy_api_v2_route_proto_rawDesc = "" +
	...
	"\x04Vhds\x12N\n" +
	"\rconfig_source\x18\x01 \x01(\v2\x1f.envoy.api.v2.core.ConfigSourceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\fconfigSourceB\x9a\x01\xf2\x98\xfe\x8f\x05\x17\x12\x15envoy.config.route.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1aio.envoyproxy.envoy.api.v2B\n" +
	"RouteProtoP\x01ZIgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2;apiv2b\x06proto3"
