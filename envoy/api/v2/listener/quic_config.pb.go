...
const file_envoy_api_v2_listener_quic_config_proto_rawDesc = "" +
	...
	"\x18crypto_handshake_timeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x16cryptoHandshakeTimeoutB\xe5\x01\xf2\x98\xfe\x8f\x05\x1a\x12\x18envoy.config.listener.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"#io.envoyproxy.envoy.api.v2.listenerB\x0fQuicConfigProtoP\x01ZLgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/listener\xaa\x02\x17Envoy.Api.V2.ListenerNS\xea\x02\x1aEnvoy::Api::V2::ListenerNSb\x06proto3"
