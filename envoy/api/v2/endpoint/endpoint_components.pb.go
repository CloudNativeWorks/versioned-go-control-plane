...
const file_envoy_api_v2_endpoint_endpoint_components_proto_rawDesc = "" +
	...
	"#io.envoyproxy.envoy.api.v2.endpointB\x17EndpointComponentsProtoP\x01Z<github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/endpointb\x06proto3"
