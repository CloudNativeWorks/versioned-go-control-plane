...
import (
	...
	v3 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/common/ratelimit/v3"
...
const file_envoy_service_ratelimit_v3_rls_proto_rawDesc = "" +
	...
	"\x0fShouldRateLimit\x12,.envoy.service.ratelimit.v3.RateLimitRequest\x1a-.envoy.service.ratelimit.v3.RateLimitResponse\"\x00B\x9d\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"(io.envoyproxy.envoy.service.ratelimit.v3B\bRlsProtoP\x01Z]github.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/ratelimit/v3;ratelimitv3b\x06proto3"
