...
const file_envoy_service_ratelimit_v2_rls_proto_rawDesc = "" +
	...
	"\x0fShouldRateLimit\x12,.envoy.service.ratelimit.v2.RateLimitRequest\x1a-.envoy.service.ratelimit.v2.RateLimitResponse\"\x00B\x9d\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"(io.envoyproxy.envoy.service.ratelimit.v2B\bRlsProtoP\x01Z]github.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/ratelimit/v2;ratelimitv2b\x06proto3"
