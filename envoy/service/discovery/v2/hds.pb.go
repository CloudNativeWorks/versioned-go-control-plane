...
const file_envoy_service_discovery_v2_hds_proto_rawDesc = "" +
	...
	"\x10FetchHealthCheck\x12F.envoy.service.discovery.v2.HealthCheckRequestOrEndpointHealthResponse\x1a0.envoy.service.discovery.v2.HealthCheckSpecifier\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v2/discovery:health_checkB\xbc\x01\xf2\x98\xfe\x8f\x05\x19\x12\x17envoy.service.health.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"(io.envoyproxy.envoy.service.discovery.v2B\bHdsProtoP\x01Z]github.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/discovery/v2;discoveryv2b\x06proto3"
