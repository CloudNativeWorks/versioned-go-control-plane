...
const file_envoy_service_discovery_v2_sds_proto_rawDesc = "" +
	...
	"\x18envoy.api.v2.auth.SecretB\xbc\x01\xf2\x98\xfe\x8f\x05\x19\x12\x17envoy.service.secret.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"(io.envoyproxy.envoy.service.discovery.v2B\bSdsProtoP\x01Z]github.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/discovery/v2;discoveryv2b\x06proto3"
