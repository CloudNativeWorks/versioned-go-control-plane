...
const file_envoy_service_discovery_v3_ads_proto_rawDesc = "" +
	...
	"\x18DeltaAggregatedResources\x121.envoy.service.discovery.v3.DeltaDiscoveryRequest\x1a2.envoy.service.discovery.v3.DeltaDiscoveryResponse\"\x00(\x010\x01B\x9d\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"(io.envoyproxy.envoy.service.discovery.v3B\bAdsProtoP\x01Z]github.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/discovery/v3;discoveryv3b\x06proto3"
