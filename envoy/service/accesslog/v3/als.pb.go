...
import (
	...
	v31 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/accesslog/v3"
...
const file_envoy_service_accesslog_v3_als_proto_rawDesc = "" +
	...
	"\x10StreamAccessLogs\x123.envoy.service.accesslog.v3.StreamAccessLogsMessage\x1a4.envoy.service.accesslog.v3.StreamAccessLogsResponse\"\x00(\x01B\x9d\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"(io.envoyproxy.envoy.service.accesslog.v3B\bAlsProtoP\x01Z]github.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/accesslog/v3;accesslogv3b\x06proto3"
