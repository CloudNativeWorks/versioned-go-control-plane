...
const file_envoy_service_route_v3_srds_proto_rawDesc = "" +
	...
	".envoy.config.route.v3.ScopedRouteConfigurationB\x92\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"$io.envoyproxy.envoy.service.route.v3B\tSrdsProtoP\x01ZUgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/route/v3;routev3b\x06proto3"
