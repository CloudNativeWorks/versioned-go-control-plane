...
import (
	...
	v2alpha "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/admin/v2alpha"
...
const file_envoy_service_status_v2_csds_proto_rawDesc = "" +
	...
	"\x11FetchClientStatus\x12,.envoy.service.status.v2.ClientStatusRequest\x1a-.envoy.service.status.v2.ClientStatusResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v2/discovery:client_statusB\x95\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"%io.envoyproxy.envoy.service.status.v2B\tCsdsProtoP\x01ZWgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/status/v2;statusv2b\x06proto3"
