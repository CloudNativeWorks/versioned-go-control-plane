...
const file_envoy_service_status_v2_csds_proto_rawDesc = "" +
	...
	"%io.envoyproxy.envoy.service.status.v2B\tCsdsProtoP\x01ZGgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/status/v2;statusv2b\x06proto3"
