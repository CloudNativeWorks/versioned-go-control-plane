...
import (
	...
	v32 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/admin/v3"
...
const file_envoy_service_status_v3_csds_proto_rawDesc = "" +
	...
	"\x11FetchClientStatus\x12,.envoy.service.status.v3.ClientStatusRequest\x1a-.envoy.service.status.v3.ClientStatusResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v3/discovery:client_statusB\x95\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"%io.envoyproxy.envoy.service.status.v3B\tCsdsProtoP\x01ZWgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/status/v3;statusv3b\x06proto3"
