...
const file_envoy_service_status_v3_csds_proto_rawDesc = "" +
	...
	"%io.envoyproxy.envoy.service.status.v3B\tCsdsProtoP\x01ZGgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/status/v3;statusv3b\x06proto3"
