...
const file_envoy_service_rate_limit_quota_v3_rlqs_proto_rawDesc = "" +
	...
	"\x15StreamRateLimitQuotas\x12=.envoy.service.rate_limit_quota.v3.RateLimitQuotaUsageReports\x1a9.envoy.service.rate_limit_quota.v3.RateLimitQuotaResponse\"\x00(\x010\x01B\xbb\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\xd2Ƥ\xe1\x06\x02\b\x01\n" +
	"/io.envoyproxy.envoy.service.rate_limit_quota.v3B\tRlqsProtoP\x01Zkgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/rate_limit_quota/v3;rate_limit_quotav3b\x06proto3"
