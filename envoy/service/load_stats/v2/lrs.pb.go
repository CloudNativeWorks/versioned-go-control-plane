...
import (
	...
	endpoint "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/endpoint"
...
const file_envoy_service_load_stats_v2_lrs_proto_rawDesc = "" +
	...
	"\x0fStreamLoadStats\x12-.envoy.service.load_stats.v2.LoadStatsRequest\x1a..envoy.service.load_stats.v2.LoadStatsResponse\"\x00(\x010\x01B\xa0\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	")io.envoyproxy.envoy.service.load_stats.v2B\bLrsProtoP\x01Z_github.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/load_stats/v2;load_statsv2b\x06proto3"
