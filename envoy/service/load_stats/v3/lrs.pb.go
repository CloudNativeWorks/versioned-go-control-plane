...
const file_envoy_service_load_stats_v3_lrs_proto_rawDesc = "" +
	...
	"\x0fStreamLoadStats\x12-.envoy.service.load_stats.v3.LoadStatsRequest\x1a..envoy.service.load_stats.v3.LoadStatsResponse\"\x00(\x010\x01B\xa0\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	")io.envoyproxy.envoy.service.load_stats.v3B\bLrsProtoP\x01Z_github.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/load_stats/v3;load_statsv3b\x06proto3"
