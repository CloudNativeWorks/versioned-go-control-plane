...
import (
	...
	v3 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/tap/v3"
...
const file_envoy_service_tap_v3_tap_proto_rawDesc = "" +
	...
	"\n" +
	"StreamTaps\x12'.envoy.service.tap.v3.StreamTapsRequest\x1a(.envoy.service.tap.v3.StreamTapsResponse\"\x00(\x01B\x8b\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"\"io.envoyproxy.envoy.service.tap.v3B\bTapProtoP\x01ZQgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/tap/v3;tapv3b\x06proto3"
