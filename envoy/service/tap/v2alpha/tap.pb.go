...
import (
	...
	v2alpha "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/tap/v2alpha"
...
const file_envoy_service_tap_v2alpha_tap_proto_rawDesc = "" +
	...
	"\n" +
	"StreamTaps\x12,.envoy.service.tap.v2alpha.StreamTapsRequest\x1a-.envoy.service.tap.v2alpha.StreamTapsResponse\"\x00(\x01B\x8f\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"'io.envoyproxy.envoy.service.tap.v2alphaB\bTapProtoP\x01ZPgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/tap/v2alphab\x06proto3"
