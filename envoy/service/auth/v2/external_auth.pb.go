...
const file_envoy_service_auth_v2_external_auth_proto_rawDesc = "" +
	...
	"\rhttp_response2e\n" +
	"\rAuthorization\x12T\n" +
	"\x05Check\x12#.envoy.service.auth.v2.CheckRequest\x1a$.envoy.service.auth.v2.CheckResponse\"\x00B\x97\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"#io.envoyproxy.envoy.service.auth.v2B\x11ExternalAuthProtoP\x01ZSgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/auth/v2;authv2b\x06proto3"
