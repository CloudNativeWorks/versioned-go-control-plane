...
const file_envoy_service_auth_v2_attribute_context_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x9b\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"#io.envoyproxy.envoy.service.auth.v2B\x15AttributeContextProtoP\x01ZSgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/auth/v2;authv2b\x06proto3"
