...
const file_envoy_service_auth_v3_attribute_context_proto_rawDesc = "" +
	...
	"&envoy.service.auth.v2.AttributeContextB\x9b\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"#io.envoyproxy.envoy.service.auth.v3B\x15AttributeContextProtoP\x01ZSgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/auth/v3;authv3b\x06proto3"
