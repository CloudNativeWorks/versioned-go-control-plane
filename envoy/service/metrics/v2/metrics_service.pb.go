...
const file_envoy_service_metrics_v2_metrics_service_proto_rawDesc = "" +
	...
	"\rStreamMetrics\x12..envoy.service.metrics.v2.StreamMetricsMessage\x1a/.envoy.service.metrics.v2.StreamMetricsResponse\"\x00(\x01B\xa2\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"&io.envoyproxy.envoy.service.metrics.v2B\x13MetricsServiceProtoP\x01ZYgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/service/metrics/v2;metricsv2b\x06proto3"
