...
const file_envoy_type_http_v3_path_transformation_proto_rawDesc = "" +
	...
	" io.envoyproxy.envoy.type.http.v3B\x17PathTransformationProtoP\x01Z@github.com/CloudNativeWorks/versioned-go-control-plane/envoy/type/http/v3;httpv3b\x06proto3"
