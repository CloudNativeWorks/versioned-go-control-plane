...
const file_envoy_type_http_v3_path_transformation_proto_rawDesc = "" +
	...
	"\fMergeSlashesB\x1a\n" +
	"\x13operation_specifier\x12\x03\xf8B\x01B\x97\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	" io.envoyproxy.envoy.type.http.v3B\x17PathTransformationProtoP\x01ZPgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/type/http/v3;httpv3b\x06proto3"
