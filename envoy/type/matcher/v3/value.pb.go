...
const file_envoy_type_matcher_v3_value_proto_rawDesc = "" +
	...
	"\tOrMatcher\x12T\n" +
	"\x0evalue_matchers\x18\x01 \x03(\v2#.envoy.type.matcher.v3.ValueMatcherB\b\xfaB\x05\x92\x01\x02\b\x02R\rvalueMatchersB\x93\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"#io.envoyproxy.envoy.type.matcher.v3B\n" +
	"ValueProtoP\x01ZVgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/type/matcher/v3;matcherv3b\x06proto3"
