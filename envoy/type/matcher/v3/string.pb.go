...
const file_envoy_type_matcher_v3_string_proto_rawDesc = "" +
	...
	"$envoy.type.matcher.ListStringMatcherB\x94\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"#io.envoyproxy.envoy.type.matcher.v3B\vStringProtoP\x01ZVgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/type/matcher/v3;matcherv3b\x06proto3"
