...
const file_envoy_type_hash_policy_proto_rawDesc = "" +
	...
	"\n" +
	"\bSourceIpB\x17\n" +
	"\x10policy_specifier\x12\x03\xf8B\x01Bx\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x18io.envoyproxy.envoy.typeB\x0fHashPolicyProtoP\x01ZAgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/typeb\x06proto3"
