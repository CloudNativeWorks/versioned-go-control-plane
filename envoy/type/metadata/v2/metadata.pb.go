...
const file_envoy_type_metadata_v2_metadata_proto_rawDesc = "" +
	...
	"\aCluster\x1a\x06\n" +
	"\x04HostB\v\n" +
	"\x04kind\x12\x03\xf8B\x01B\xb7\x01\xf2\x98\xfe\x8f\x05\x18\x12\x16envoy.type.metadata.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"$io.envoyproxy.envoy.type.metadata.v2B\rMetadataProtoP\x01ZXgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/type/metadata/v2;metadatav2b\x06proto3"
