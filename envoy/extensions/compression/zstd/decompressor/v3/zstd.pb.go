...
const file_envoy_extensions_compression_zstd_decompressor_v3_zstd_proto_rawDesc = "" +
	...
	"\n" +
	"chunk_size\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueB\f\xfaB\t*\a\x18\x80\x80\x04(\x80 R\tchunkSizeB\xcf\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"?io.envoyproxy.envoy.extensions.compression.zstd.decompressor.v3B\tZstdProtoP\x01Zwgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/compression/zstd/decompressor/v3;decompressorv3b\x06proto3"
