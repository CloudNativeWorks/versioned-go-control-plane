...
const file_envoy_extensions_bootstrap_reverse_tunnel_upstream_socket_interface_v3_upstream_reverse_connection_socket_interface_proto_rawDesc = "" +
	...
	"\n" +
	"access_log\x18\x06 \x03(\v2$.envoy.config.accesslog.v3.AccessLogR\taccessLogB\xab\x02\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Tio.envoyproxy.envoy.extensions.bootstrap.reverse_tunnel.upstream_socket_interface.v3B-UpstreamReverseConnectionSocketInterfaceProtoP\x01Z\x99\x01github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/bootstrap/reverse_tunnel/upstream_socket_interface/v3;upstream_socket_interfacev3b\x06proto3"
