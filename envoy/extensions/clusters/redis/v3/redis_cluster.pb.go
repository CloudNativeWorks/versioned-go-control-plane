...
const file_envoy_extensions_clusters_redis_v3_redis_cluster_proto_rawDesc = "" +
	...
	"-envoy.config.cluster.redis.RedisClusterConfigB\xb2\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"0io.envoyproxy.envoy.extensions.clusters.redis.v3B\x11RedisClusterProtoP\x01Zagithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/clusters/redis/v3;redisv3b\x06proto3"
