...
import (
	...
	v31 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/cluster/v3"
	v32 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/core/v3"
	v33 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/clusters/dns/v3"
...
const file_envoy_extensions_clusters_dynamic_forward_proxy_v3_cluster_proto_rawDesc = "" +
	...
	"\x12dns_cluster_config\x18\x05 \x01(\v2,.envoy.extensions.clusters.dns.v3.DnsClusterR\x10dnsClusterConfigB\xde\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"@io.envoyproxy.envoy.extensions.clusters.dynamic_forward_proxy.v3B\fClusterProtoP\x01Z\x81\x01github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/clusters/dynamic_forward_proxy/v3;dynamic_forward_proxyv3b\x06proto3"
