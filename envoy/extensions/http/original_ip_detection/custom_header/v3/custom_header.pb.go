...
const file_envoy_extensions_http_original_ip_detection_custom_header_v3_custom_header_proto_rawDesc = "" +
	...
	"\x12reject_with_status\x18\x03 \x01(\v2\x19.envoy.type.v3.HttpStatusR\x10rejectWithStatusB\xef\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Jio.envoyproxy.envoy.extensions.http.original_ip_detection.custom_header.v3B\x11CustomHeaderProtoP\x01Z\x83\x01github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/http/original_ip_detection/custom_header/v3;custom_headerv3b\x06proto3"
