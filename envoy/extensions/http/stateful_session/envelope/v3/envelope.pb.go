...
const file_envoy_extensions_http_stateful_session_envelope_v3_envelope_proto_rawDesc = "" +
	...
	"\x06Header\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x04nameB\xd1\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"@io.envoyproxy.envoy.extensions.http.stateful_session.envelope.v3B\rEnvelopeProtoP\x01Ztgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/http/stateful_session/envelope/v3;envelopev3b\x06proto3"
