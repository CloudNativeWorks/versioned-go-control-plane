...
const file_envoy_extensions_http_stateful_session_cookie_v3_cookie_proto_rawDesc = "" +
	...
	">io.envoyproxy.envoy.extensions.http.stateful_session.cookie.v3B\vCookieProtoP\x01Z`github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/http/stateful_session/cookie/v3;cookiev3b\x06proto3"
