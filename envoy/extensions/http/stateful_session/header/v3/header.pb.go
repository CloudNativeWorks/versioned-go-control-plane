...
const file_envoy_extensions_http_stateful_session_header_v3_header_proto_rawDesc = "" +
	...
	">io.envoyproxy.envoy.extensions.http.stateful_session.header.v3B\vHeaderProtoP\x01Z`github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/http/stateful_session/header/v3;headerv3b\x06proto3"
