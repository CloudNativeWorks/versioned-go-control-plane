...
const file_envoy_extensions_http_stateful_session_header_v3_header_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x04nameB\xc9\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	">io.envoyproxy.envoy.extensions.http.stateful_session.header.v3B\vHeaderProtoP\x01Zpgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/http/stateful_session/header/v3;headerv3b\x06proto3"
