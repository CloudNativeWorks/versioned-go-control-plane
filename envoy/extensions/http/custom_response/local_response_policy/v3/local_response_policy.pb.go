...
const file_envoy_extensions_http_custom_response_local_response_policy_v3_local_response_policy_proto_rawDesc = "" +
	...
	"statusCode\x12i\n" +
	"\x17response_headers_to_add\x18\x04 \x03(\v2'.envoy.config.core.v3.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x14responseHeadersToAddB\x8a\x02\xba\x80\xc8\xd1\x06\x02\x10\x02\xd2Ƥ\xe1\x06\x02\b\x01\n" +
	"Lio.envoyproxy.envoy.extensions.http.custom_response.local_response_policy.v3B\x18LocalResponsePolicyProtoP\x01Z\x8d\x01github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/http/custom_response/local_response_policy/v3;local_response_policyv3b\x06proto3"
