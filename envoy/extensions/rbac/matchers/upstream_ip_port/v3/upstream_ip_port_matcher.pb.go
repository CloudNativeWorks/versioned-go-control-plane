...
const file_envoy_extensions_rbac_matchers_upstream_ip_port_v3_upstream_ip_port_matcher_proto_rawDesc = "" +
	...
	"upstreamIp\x12I\n" +
	"\x13upstream_port_range\x18\x02 \x01(\v2\x19.envoy.type.v3.Int64RangeR\x11upstreamPortRangeB\xe6\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"@io.envoyproxy.envoy.extensions.rbac.matchers.upstream_ip_port.v3B\x1aUpstreamIpPortMatcherProtoP\x01Z|github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/rbac/matchers/upstream_ip_port/v3;upstream_ip_portv3b\x06proto3"
