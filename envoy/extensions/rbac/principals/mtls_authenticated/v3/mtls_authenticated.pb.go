...
const file_envoy_extensions_rbac_principals_mtls_authenticated_v3_mtls_authenticated_proto_rawDesc = "" +
	...
	"sanMatcher\x12G\n" +
	" any_validated_client_certificate\x18\x02 \x01(\bR\x1danyValidatedClientCertificateB\xed\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Dio.envoyproxy.envoy.extensions.rbac.principals.mtls_authenticated.v3B\x16MtlsAuthenticatedProtoP\x01Z\x82\x01github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/rbac/principals/mtls_authenticated/v3;mtls_authenticatedv3b\x06proto3"
