...
const file_envoy_extensions_matching_common_inputs_ssl_v3_ssl_inputs_proto_rawDesc = "" +
	...
	"\vUriSanInput\"\r\n" +
	"\vDnsSanInput\"\x0e\n" +
	"\fSubjectInputB\xc5\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"<io.envoyproxy.envoy.extensions.matching.common_inputs.ssl.v3B\x0eSslInputsProtoP\x01Zkgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/matching/common_inputs/ssl/v3;sslv3b\x06proto3"
