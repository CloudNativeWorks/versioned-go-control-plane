...
const file_envoy_extensions_access_loggers_filters_cel_v3_cel_proto_rawDesc = "" +
	...
	"expression\x12H\n" +
	"\n" +
	"cel_config\x18\x02 \x01(\v2).envoy.config.core.v3.CelExpressionConfigR\tcelConfigB\xbf\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"<io.envoyproxy.envoy.extensions.access_loggers.filters.cel.v3B\bCelProtoP\x01Zkgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/access_loggers/filters/cel/v3;celv3b\x06proto3"
