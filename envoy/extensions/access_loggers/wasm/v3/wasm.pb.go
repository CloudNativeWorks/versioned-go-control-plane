...
const file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDesc = "" +
	...
	"\rWasmAccessLog\x12>\n" +
	"\x06config\x18\x01 \x01(\v2&.envoy.extensions.wasm.v3.PluginConfigR\x06configB\xb3\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"5io.envoyproxy.envoy.extensions.access_loggers.wasm.v3B\tWasmProtoP\x01Zegithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/access_loggers/wasm/v3;wasmv3b\x06proto3"
