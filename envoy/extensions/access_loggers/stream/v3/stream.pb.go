...
const file_envoy_extensions_access_loggers_stream_v3_stream_proto_rawDesc = "" +
	...
	"\n" +
	"log_format\x18\x01 \x01(\v2..envoy.config.core.v3.SubstitutionFormatStringB\b\xfaB\x05\x8a\x01\x02\x10\x01H\x00R\tlogFormatB\x13\n" +
	"\x11access_log_formatB\xbb\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"7io.envoyproxy.envoy.extensions.access_loggers.stream.v3B\vStreamProtoP\x01Zigithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/access_loggers/stream/v3;streamv3b\x06proto3"
