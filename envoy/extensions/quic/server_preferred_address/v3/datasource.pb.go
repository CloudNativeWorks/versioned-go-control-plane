...
const file_envoy_extensions_quic_server_preferred_address_v3_datasource_proto_rawDesc = "" +
	...
	"\fdnat_address\x18\x03 \x01(\v2 .envoy.config.core.v3.DataSourceR\vdnatAddressB\xe2\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"?io.envoyproxy.envoy.extensions.quic.server_preferred_address.v3B\x0fDatasourceProtoP\x01Z\x83\x01github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/quic/server_preferred_address/v3;server_preferred_addressv3b\x06proto3"
