...
const file_envoy_extensions_load_balancing_policies_random_v3_random_proto_rawDesc = "" +
	...
	"\x06Random\x12r\n" +
	"\x12locality_lb_config\x18\x01 \x01(\v2D.envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfigR\x10localityLbConfigB\xcd\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"@io.envoyproxy.envoy.extensions.load_balancing_policies.random.v3B\vRandomProtoP\x01Zrgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/load_balancing_policies/random/v3;randomv3b\x06proto3"
