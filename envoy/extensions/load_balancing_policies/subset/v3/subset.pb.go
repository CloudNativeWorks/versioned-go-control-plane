...
const file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDesc = "" +
	...
	"&envoy.config.cluster.v3.LbSubsetConfigB\xcd\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"@io.envoyproxy.envoy.extensions.load_balancing_policies.subset.v3B\vSubsetProtoP\x01Zrgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/load_balancing_policies/subset/v3;subsetv3b\x06proto3"
