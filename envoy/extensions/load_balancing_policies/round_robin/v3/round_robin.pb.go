...
const file_envoy_extensions_load_balancing_policies_round_robin_v3_round_robin_proto_rawDesc = "" +
	...
	"\x12locality_lb_config\x18\x02 \x01(\v2D.envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfigR\x10localityLbConfigB\xe0\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Eio.envoyproxy.envoy.extensions.load_balancing_policies.round_robin.v3B\x0fRoundRobinProtoP\x01Z|github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/load_balancing_policies/round_robin/v3;round_robinv3b\x06proto3"
