...
const file_envoy_extensions_load_balancing_policies_wrr_locality_v3_wrr_locality_proto_rawDesc = "" +
	...
	"\vWrrLocality\x12n\n" +
	"\x17endpoint_picking_policy\x18\x01 \x01(\v2,.envoy.config.cluster.v3.LoadBalancingPolicyB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x15endpointPickingPolicyB\xe4\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Fio.envoyproxy.envoy.extensions.load_balancing_policies.wrr_locality.v3B\x10WrrLocalityProtoP\x01Z~github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/load_balancing_policies/wrr_locality/v3;wrr_localityv3b\x06proto3"
