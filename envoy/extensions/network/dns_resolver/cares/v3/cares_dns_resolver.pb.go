...
const file_envoy_extensions_network_dns_resolver_cares_v3_cares_dns_resolver_proto_rawDesc = "" +
	...
	"<io.envoyproxy.envoy.extensions.network.dns_resolver.cares.v3B\x15CaresDnsResolverProtoP\x01Z]github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/network/dns_resolver/cares/v3;caresv3b\x06proto3"
