...
const file_envoy_extensions_tracers_fluentd_v3_fluentd_proto_rawDesc = "" +
	...
	"\fretry_policy\x18\x06 \x01(\v2!.envoy.config.core.v3.RetryPolicyR\vretryPolicyB\xe1\x01\xf2\x98\xfe\x8f\x05*\x12(envoy.extensions.tracers.fluentd.v4alpha\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"1io.envoyproxy.envoy.extensions.tracers.fluentd.v3B\fFluentdProtoP\x01Zdgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/tracers/fluentd/v3;fluentdv3b\x06proto3"
