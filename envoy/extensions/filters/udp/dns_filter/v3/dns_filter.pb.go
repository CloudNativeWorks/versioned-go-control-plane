...
import (
	...
	v3 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/accesslog/v3"
	v32 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/core/v3"
	v31 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/dns/v3"
...
const file_envoy_extensions_filters_udp_dns_filter_v3_dns_filter_proto_rawDesc = "" +
	...
	"\x13max_pending_lookups\x18\x03 \x01(\x04B\a\xfaB\x042\x02(\x01R\x11maxPendingLookupsB\xc4\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"8io.envoyproxy.envoy.extensions.filters.udp.dns_filter.v3B\x0eDnsFilterProtoP\x01Zngithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/udp/dns_filter/v3;dns_filterv3b\x06proto3"
