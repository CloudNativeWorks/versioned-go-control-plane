...
const file_envoy_extensions_filters_network_ext_authz_v3_ext_authz_proto_rawDesc = "" +
	...
	"1envoy.config.filter.network.ext_authz.v2.ExtAuthzB\xc8\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	";io.envoyproxy.envoy.extensions.filters.network.ext_authz.v3B\rExtAuthzProtoP\x01Zpgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/ext_authz/v3;ext_authzv3b\x06proto3"
