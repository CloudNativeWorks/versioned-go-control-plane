...
const file_envoy_extensions_filters_network_reverse_tunnel_v3_reverse_tunnel_proto_rawDesc = "" +
	...
	"validation\x12?\n" +
	"\x15required_cluster_name\x18\x06 \x01(\tB\v\xfaB\br\x06\x18\xff\x01\xd0\x01\x01R\x13requiredClusterNameB\xdc\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"@io.envoyproxy.envoy.extensions.filters.network.reverse_tunnel.v3B\x12ReverseTunnelProtoP\x01Zzgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/reverse_tunnel/v3;reverse_tunnelv3b\x06proto3"
