...
const file_envoy_extensions_filters_network_local_ratelimit_v3_local_rate_limit_proto_rawDesc = "" +
	...
	"Cenvoy.config.filter.network.local_rate_limit.v2alpha.LocalRateLimitB\xe0\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Aio.envoyproxy.envoy.extensions.filters.network.local_ratelimit.v3B\x13LocalRateLimitProtoP\x01Z|github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/local_ratelimit/v3;local_ratelimitv3b\x06proto3"
