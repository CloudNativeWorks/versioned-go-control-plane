...
const file_envoy_extensions_filters_network_wasm_v3_wasm_proto_rawDesc = "" +
	...
	"\x04Wasm\x12>\n" +
	"\x06config\x18\x01 \x01(\v2&.envoy.extensions.wasm.v3.PluginConfigR\x06configB\xb5\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"6io.envoyproxy.envoy.extensions.filters.network.wasm.v3B\tWasmProtoP\x01Zfgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/wasm/v3;wasmv3b\x06proto3"
