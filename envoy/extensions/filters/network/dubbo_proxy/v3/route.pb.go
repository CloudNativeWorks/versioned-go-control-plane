...
import (
	...
	v3 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/route/v3"
...
const file_envoy_extensions_filters_network_dubbo_proxy_v3_route_proto_rawDesc = "" +
	...
	"\froute_config\x18\x04 \x03(\v2C.envoy.extensions.filters.network.dubbo_proxy.v3.RouteConfigurationR\vrouteConfigB\xcb\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"=io.envoyproxy.envoy.extensions.filters.network.dubbo_proxy.v3B\n" +
	"RouteProtoP\x01Ztgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/dubbo_proxy/v3;dubbo_proxyv3b\x06proto3"
