...
const file_envoy_extensions_filters_network_connection_limit_v3_connection_limit_proto_rawDesc = "" +
	...
	"\x0fruntime_enabled\x18\x04 \x01(\v2(.envoy.config.core.v3.RuntimeFeatureFlagR\x0eruntimeEnabledB\xe4\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Bio.envoyproxy.envoy.extensions.filters.network.connection_limit.v3B\x14ConnectionLimitProtoP\x01Z~github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/connection_limit/v3;connection_limitv3b\x06proto3"
