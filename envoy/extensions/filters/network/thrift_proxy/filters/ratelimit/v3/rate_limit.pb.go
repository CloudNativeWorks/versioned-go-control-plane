...
const file_envoy_extensions_filters_network_thrift_proxy_filters_ratelimit_v3_rate_limit_proto_rawDesc = "" +
	...
	"8envoy.config.filter.thrift.rate_limit.v2alpha1.RateLimitB\xf4\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Pio.envoyproxy.envoy.extensions.filters.network.thrift_proxy.filters.ratelimit.v3B\x0eRateLimitProtoP\x01Z\x85\x01github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/thrift_proxy/filters/ratelimit/v3;ratelimitv3b\x06proto3"
