...
const file_envoy_extensions_filters_network_thrift_proxy_filters_header_to_metadata_v3_header_to_metadata_proto_rawDesc = "" +
	...
	"\x04NONE\x10\x00\x12\n" +
	"\n" +
	"\x06BASE64\x10\x01B\x96\x02\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Yio.envoyproxy.envoy.extensions.filters.network.thrift_proxy.filters.header_to_metadata.v3B\x15HeaderToMetadataProtoP\x01Z\x97\x01github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/thrift_proxy/filters/header_to_metadata/v3;header_to_metadatav3b\x06proto3"
