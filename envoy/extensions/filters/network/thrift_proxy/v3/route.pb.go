...
const file_envoy_extensions_filters_network_thrift_proxy_v3_route_proto_rawDesc = "" +
	...
	"Aenvoy.config.filter.network.thrift_proxy.v2alpha1.WeightedClusterB\xce\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	">io.envoyproxy.envoy.extensions.filters.network.thrift_proxy.v3B\n" +
	"RouteProtoP\x01Zvgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/thrift_proxy/v3;thrift_proxyv3b\x06proto3"
