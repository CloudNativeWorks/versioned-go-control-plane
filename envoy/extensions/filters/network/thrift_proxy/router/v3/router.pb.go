...
const file_envoy_extensions_filters_network_thrift_proxy_router_v3_router_proto_rawDesc = "" +
	...
	"1envoy.config.filter.thrift.router.v2alpha1.RouterB\xd7\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Eio.envoyproxy.envoy.extensions.filters.network.thrift_proxy.router.v3B\vRouterProtoP\x01Zwgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/thrift_proxy/router/v3;routerv3b\x06proto3"
