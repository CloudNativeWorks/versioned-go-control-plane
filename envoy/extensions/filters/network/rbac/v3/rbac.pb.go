...
const file_envoy_extensions_filters_network_rbac_v3_rbac_proto_rawDesc = "" +
	...
	"(envoy.config.filter.network.rbac.v2.RBACB\xb5\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"6io.envoyproxy.envoy.extensions.filters.network.rbac.v3B\tRbacProtoP\x01Zfgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/network/rbac/v3;rbacv3b\x06proto3"
