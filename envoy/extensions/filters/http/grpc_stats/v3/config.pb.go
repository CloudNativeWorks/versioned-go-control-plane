...
const file_envoy_extensions_filters_http_grpc_stats_v3_config_proto_rawDesc = "" +
	...
	"8envoy.config.filter.http.grpc_stats.v2alpha.FilterObjectB\xc3\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"9io.envoyproxy.envoy.extensions.filters.http.grpc_stats.v3B\vConfigProtoP\x01Zogithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/grpc_stats/v3;grpc_statsv3b\x06proto3"
