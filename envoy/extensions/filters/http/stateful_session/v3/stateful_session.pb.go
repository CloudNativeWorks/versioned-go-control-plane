...
const file_envoy_extensions_filters_http_stateful_session_v3_stateful_session_proto_rawDesc = "" +
	...
	"\boverride\x12\x03\xf8B\x01B\xde\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"?io.envoyproxy.envoy.extensions.filters.http.stateful_session.v3B\x14StatefulSessionProtoP\x01Z{github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/stateful_session/v3;stateful_sessionv3b\x06proto3"
