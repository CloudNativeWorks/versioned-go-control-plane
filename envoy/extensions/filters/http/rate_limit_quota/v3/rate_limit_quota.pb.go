...
const file_envoy_extensions_filters_http_rate_limit_quota_v3_rate_limit_quota_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2l.envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaBucketSettings.BucketIdBuilder.ValueBuilderR\x05value:\x028\x01B\xe5\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\xd2Ƥ\xe1\x06\x02\b\x01\n" +
	"?io.envoyproxy.envoy.extensions.filters.http.rate_limit_quota.v3B\x13RateLimitQuotaProtoP\x01Z{github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/rate_limit_quota/v3;rate_limit_quotav3b\x06proto3"
