...
const file_envoy_extensions_filters_http_csrf_v3_csrf_proto_rawDesc = "" +
	...
	"+envoy.config.filter.http.csrf.v2.CsrfPolicyB\xaf\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"3io.envoyproxy.envoy.extensions.filters.http.csrf.v3B\tCsrfProtoP\x01Zcgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/csrf/v3;csrfv3b\x06proto3"
