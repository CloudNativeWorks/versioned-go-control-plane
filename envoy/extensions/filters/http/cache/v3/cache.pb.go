...
const file_envoy_extensions_filters_http_cache_v3_cache_proto_rawDesc = "" +
	...
	"2envoy.config.filter.http.cache.v2alpha.CacheConfigB\xb3\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"4io.envoyproxy.envoy.extensions.filters.http.cache.v3B\n" +
	"CacheProtoP\x01Zegithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/cache/v3;cachev3b\x06proto3"
