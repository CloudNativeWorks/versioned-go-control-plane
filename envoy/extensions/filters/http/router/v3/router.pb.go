...
const file_envoy_extensions_filters_http_router_v3_router_proto_rawDesc = "" +
	...
	")envoy.config.filter.http.router.v2.RouterB\xb7\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"5io.envoyproxy.envoy.extensions.filters.http.router.v3B\vRouterProtoP\x01Zggithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/router/v3;routerv3b\x06proto3"
