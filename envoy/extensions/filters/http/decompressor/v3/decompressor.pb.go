...
const file_envoy_extensions_filters_http_decompressor_v3_decompressor_proto_rawDesc = "" +
	...
	"\rcommon_config\x18\x01 \x01(\v2Q.envoy.extensions.filters.http.decompressor.v3.Decompressor.CommonDirectionConfigR\fcommonConfigB\xcf\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	";io.envoyproxy.envoy.extensions.filters.http.decompressor.v3B\x11DecompressorProtoP\x01Zsgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/decompressor/v3;decompressorv3b\x06proto3"
