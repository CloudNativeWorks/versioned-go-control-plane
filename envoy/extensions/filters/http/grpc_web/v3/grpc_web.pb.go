...
const file_envoy_extensions_filters_http_grpc_web_v3_grpc_web_proto_rawDesc = "" +
	...
	"\aGrpcWeb:3\x9aň\x1e.\n" +
	",envoy.config.filter.http.grpc_web.v2.GrpcWebB\xbe\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"7io.envoyproxy.envoy.extensions.filters.http.grpc_web.v3B\fGrpcWebProtoP\x01Zkgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/grpc_web/v3;grpc_webv3b\x06proto3"
