...
import (
	...
	v3 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/common/async_files/v3"
...
const file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_rawDesc = "" +
	...
	"\bresponse\x18\x04 \x01(\v2A.envoy.extensions.filters.http.file_system_buffer.v3.StreamConfigR\bresponseB\xed\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\xd2Ƥ\xe1\x06\x02\b\x01\n" +
	"Aio.envoyproxy.envoy.extensions.filters.http.file_system_buffer.v3B\x15FileSystemBufferProtoP\x01Z\x7fgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/file_system_buffer/v3;file_system_bufferv3b\x06proto3"
