...
const file_envoy_extensions_filters_http_thrift_to_metadata_v3_thrift_to_metadata_proto_rawDesc = "" +
	...
	"\n" +
	"REPLY_TYPE\x10\x06B\xe5\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Aio.envoyproxy.envoy.extensions.filters.http.thrift_to_metadata.v3B\x15ThriftToMetadataProtoP\x01Z\x7fgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/thrift_to_metadata/v3;thrift_to_metadatav3b\x06proto3"
