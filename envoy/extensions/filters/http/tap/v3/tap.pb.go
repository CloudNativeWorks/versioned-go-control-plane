...
const file_envoy_extensions_filters_http_tap_v3_tap_proto_rawDesc = "" +
	...
	"(envoy.config.filter.http.tap.v2alpha.TapB\xab\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"2io.envoyproxy.envoy.extensions.filters.http.tap.v3B\bTapProtoP\x01Zagithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/tap/v3;tapv3b\x06proto3"
