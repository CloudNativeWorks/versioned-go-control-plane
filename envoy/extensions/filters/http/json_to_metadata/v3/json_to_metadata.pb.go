...
const file_envoy_extensions_filters_http_json_to_metadata_v3_json_to_metadata_proto_rawDesc = "" +
	...
	"\n" +
	"\x06NUMBER\x10\x02B\xdd\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"?io.envoyproxy.envoy.extensions.filters.http.json_to_metadata.v3B\x13JsonToMetadataProtoP\x01Z{github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/json_to_metadata/v3;json_to_metadatav3b\x06proto3"
