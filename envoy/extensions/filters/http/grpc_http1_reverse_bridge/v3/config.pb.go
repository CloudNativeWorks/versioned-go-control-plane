...
const file_envoy_extensions_filters_http_grpc_http1_reverse_bridge_v3_config_proto_rawDesc = "" +
	...
	"Penvoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1.FilterConfigPerRouteB\xf1\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Hio.envoyproxy.envoy.extensions.filters.http.grpc_http1_reverse_bridge.v3B\vConfigProtoP\x01Z\x8d\x01github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/grpc_http1_reverse_bridge/v3;grpc_http1_reverse_bridgev3b\x06proto3"
