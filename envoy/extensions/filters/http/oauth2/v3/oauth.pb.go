...
import (
	...
	v3 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/transport_sockets/tls/v3"
...
const file_envoy_extensions_filters_http_oauth2_v3_oauth_proto_rawDesc = "" +
	...
	"\x06OAuth2\x12M\n" +
	"\x06config\x18\x01 \x01(\v25.envoy.extensions.filters.http.oauth2.v3.OAuth2ConfigR\x06configB\xb6\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"5io.envoyproxy.envoy.extensions.filters.http.oauth2.v3B\n" +
	"OauthProtoP\x01Zggithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/oauth2/v3;oauth2v3b\x06proto3"
