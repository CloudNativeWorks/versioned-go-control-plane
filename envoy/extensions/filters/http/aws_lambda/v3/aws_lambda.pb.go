...
const file_envoy_extensions_filters_http_aws_lambda_v3_aws_lambda_proto_rawDesc = "" +
	...
	":envoy.config.filter.http.aws_lambda.v2alpha.PerRouteConfigB\xc6\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"9io.envoyproxy.envoy.extensions.filters.http.aws_lambda.v3B\x0eAwsLambdaProtoP\x01Zogithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/aws_lambda/v3;aws_lambdav3b\x06proto3"
