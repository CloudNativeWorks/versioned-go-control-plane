...
import (
	...
	v3 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/rbac/v3"
...
const file_envoy_extensions_filters_http_rbac_v3_rbac_proto_rawDesc = "" +
	...
	"-envoy.config.filter.http.rbac.v2.RBACPerRouteJ\x04\b\x01\x10\x02B\xaf\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"3io.envoyproxy.envoy.extensions.filters.http.rbac.v3B\tRbacProtoP\x01Zcgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/filters/http/rbac/v3;rbacv3b\x06proto3"
