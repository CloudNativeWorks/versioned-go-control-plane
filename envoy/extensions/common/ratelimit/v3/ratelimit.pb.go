...
const file_envoy_extensions_common_ratelimit_v3_ratelimit_proto_rawDesc = "" +
	...
	"\n" +
	"\x06IGNORE\x10\x02B\xb7\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"2io.envoyproxy.envoy.extensions.common.ratelimit.v3B\x0eRatelimitProtoP\x01Zggithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/common/ratelimit/v3;ratelimitv3b\x06proto3"
