...
const file_envoy_extensions_resource_monitors_cpu_utilization_v3_cpu_utilization_proto_rawDesc = "" +
	...
	"\x04HOST\x10\x00\x12\r\n" +
	"\tCONTAINER\x10\x01B\xe4\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"Cio.envoyproxy.envoy.extensions.resource_monitors.cpu_utilization.v3B\x13CpuUtilizationProtoP\x01Z~github.com/CloudNativeWorks/versioned-go-control-plane/envoy/extensions/resource_monitors/cpu_utilization/v3;cpu_utilizationv3b\x06proto3"
