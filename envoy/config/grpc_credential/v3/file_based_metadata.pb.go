...
const file_envoy_config_grpc_credential_v3_file_based_metadata_proto_rawDesc = "" +
	...
	"<envoy.config.grpc_credential.v2alpha.FileBasedMetadataConfigB\xbb\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"-io.envoyproxy.envoy.config.grpc_credential.v3B\x16FileBasedMetadataProtoP\x01Zhgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/grpc_credential/v3;grpc_credentialv3b\x06proto3"
