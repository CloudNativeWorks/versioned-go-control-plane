...
const file_envoy_config_trace_v2_http_tracer_proto_rawDesc = "" +
	...
	"#io.envoyproxy.envoy.config.trace.v2B\x0fHttpTracerProtoP\x01ZDgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v2;tracev2b\x06proto3"
