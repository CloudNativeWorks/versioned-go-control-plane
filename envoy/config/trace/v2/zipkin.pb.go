...
const file_envoy_config_trace_v2_zipkin_proto_rawDesc = "" +
	...
	"#io.envoyproxy.envoy.config.trace.v2B\vZipkinProtoP\x01ZDgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v2;tracev2b\x06proto3"
