...
const file_envoy_config_trace_v2_service_proto_rawDesc = "" +
	...
	"\fgrpc_service\x18\x01 \x01(\v2\x1e.envoy.api.v2.core.GrpcServiceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vgrpcServiceB\x93\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"#io.envoyproxy.envoy.config.trace.v2B\fServiceProtoP\x01ZTgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v2;tracev2b\x06proto3"
