...
const file_envoy_config_trace_v2_service_proto_rawDesc = "" +
	...
	"#io.envoyproxy.envoy.config.trace.v2B\fServiceProtoP\x01ZDgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v2;tracev2b\x06proto3"
