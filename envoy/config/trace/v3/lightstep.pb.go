...
const file_envoy_config_trace_v3_lightstep_proto_rawDesc = "" +
	...
	"%envoy.config.trace.v2.LightstepConfigB\xc7\x01\xf2\x98\xfe\x8f\x05,\x12*envoy.extensions.tracers.lightstep.v4alpha\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"#io.envoyproxy.envoy.config.trace.v3B\x0eLightstepProtoP\x01ZTgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v3;tracev3b\x06proto3"
