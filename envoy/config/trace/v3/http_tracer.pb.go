...
const file_envoy_config_trace_v3_http_tracer_proto_rawDesc = "" +
	...
	"\x1denvoy.config.trace.v2.TracingB\x96\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"#io.envoyproxy.envoy.config.trace.v3B\x0fHttpTracerProtoP\x01ZTgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v3;tracev3b\x06proto3"
