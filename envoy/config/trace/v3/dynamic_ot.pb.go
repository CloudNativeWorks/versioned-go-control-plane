...
const file_envoy_config_trace_v3_dynamic_ot_proto_rawDesc = "" +
	...
	"#io.envoyproxy.envoy.config.trace.v3B\x0eDynamicOtProtoP\x01ZDgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v3;tracev3b\x06proto3"
