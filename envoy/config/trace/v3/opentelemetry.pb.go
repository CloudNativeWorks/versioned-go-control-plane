...
const file_envoy_config_trace_v3_opentelemetry_proto_rawDesc = "" +
	...
	"#io.envoyproxy.envoy.config.trace.v3B\x12OpentelemetryProtoP\x01ZDgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v3;tracev3b\x06proto3"
