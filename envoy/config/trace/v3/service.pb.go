...
const file_envoy_config_trace_v3_service_proto_rawDesc = "" +
	...
	"#io.envoyproxy.envoy.config.trace.v3B\fServiceProtoP\x01ZDgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v3;tracev3b\x06proto3"
