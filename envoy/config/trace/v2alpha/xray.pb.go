...
const file_envoy_config_trace_v2alpha_xray_proto_rawDesc = "" +
	...
	"\x16sampling_rule_manifest\x18\x03 \x01(\v2\x1d.envoy.api.v2.core.DataSourceR\x14samplingRuleManifestB\x92\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"(io.envoyproxy.envoy.config.trace.v2alphaB\tXrayProtoP\x01ZQgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v2alphab\x06proto3"
