...
const file_envoy_config_trace_v2alpha_xray_proto_rawDesc = "" +
	...
	"(io.envoyproxy.envoy.config.trace.v2alphaB\tXrayProtoP\x01ZAgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v2alphab\x06proto3"
