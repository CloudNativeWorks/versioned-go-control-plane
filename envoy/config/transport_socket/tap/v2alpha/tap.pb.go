...
import (
	...
	v2alpha "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/common/tap/v2alpha"
...
const file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDesc = "" +
	...
	"\x10transport_socket\x18\x02 \x01(\v2\".envoy.api.v2.core.TransportSocketB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x0ftransportSocketB\xe2\x01\xf2\x98\xfe\x8f\x05+\x12)envoy.extensions.transport_sockets.tap.v3\xba\x80\xc8\xd1\x06\x04\b\x01\x10\x01\n" +
	"7io.envoyproxy.envoy.config.transport_socket.tap.v2alphaB\bTapProtoP\x01Z`github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/transport_socket/tap/v2alphab\x06proto3"
