...
const file_envoy_config_cluster_v3_filter_proto_rawDesc = "" +
	...
	"%io.envoyproxy.envoy.config.cluster.v3B\vFilterProtoP\x01ZHgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/cluster/v3;clusterv3b\x06proto3"
