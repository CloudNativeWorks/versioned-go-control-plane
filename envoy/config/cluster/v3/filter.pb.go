...
const file_envoy_config_cluster_v3_filter_proto_rawDesc = "" +
	...
	"\x1benvoy.api.v2.cluster.FilterB\x98\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"%io.envoyproxy.envoy.config.cluster.v3B\vFilterProtoP\x01ZXgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/cluster/v3;clusterv3b\x06proto3"
