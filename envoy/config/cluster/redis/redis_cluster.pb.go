...
const file_envoy_config_cluster_redis_redis_cluster_proto_rawDesc = "" +
	...
	"(io.envoyproxy.envoy.config.cluster.redisB\x11RedisClusterProtoP\x01ZAgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/cluster/redisb\x06proto3"
