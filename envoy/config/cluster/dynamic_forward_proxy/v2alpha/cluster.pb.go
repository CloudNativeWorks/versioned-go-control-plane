...
import (
	...
	v2alpha "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/common/dynamic_forward_proxy/v2alpha"
...
const file_envoy_config_cluster_dynamic_forward_proxy_v2alpha_cluster_proto_rawDesc = "" +
	...
	"\rClusterConfig\x12u\n" +
	"\x10dns_cache_config\x18\x01 \x01(\v2A.envoy.config.common.dynamic_forward_proxy.v2alpha.DnsCacheConfigB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x0ednsCacheConfigB\xff\x01\xf2\x98\xfe\x8f\x054\x122envoy.extensions.clusters.dynamic_forward_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"@io.envoyproxy.envoy.config.cluster.dynamic_forward_proxy.v2alphaB\fClusterProtoP\x01Zigithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/cluster/dynamic_forward_proxy/v2alphab\x06proto3"
