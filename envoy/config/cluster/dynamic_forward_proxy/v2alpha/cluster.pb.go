...
const file_envoy_config_cluster_dynamic_forward_proxy_v2alpha_cluster_proto_rawDesc = "" +
	...
	"@io.envoyproxy.envoy.config.cluster.dynamic_forward_proxy.v2alphaB\fClusterProtoP\x01ZYgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/cluster/dynamic_forward_proxy/v2alphab\x06proto3"
