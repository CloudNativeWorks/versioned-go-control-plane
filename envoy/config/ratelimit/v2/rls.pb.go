...
const file_envoy_config_ratelimit_v2_rls_proto_rawDesc = "" +
	...
	"'io.envoyproxy.envoy.config.ratelimit.v2B\bRlsProtoP\x01ZLgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/ratelimit/v2;ratelimitv2b\x06proto3"
