...
const file_envoy_config_upstream_local_address_selector_v3_default_local_address_selector_proto_rawDesc = "" +
	...
	"=io.envoyproxy.envoy.config.upstream.local_address_selector.v3B DefaultLocalAddressSelectorProtoP\x01Zogithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/upstream/local_address_selector/v3;local_address_selectorv3b\x06proto3"
