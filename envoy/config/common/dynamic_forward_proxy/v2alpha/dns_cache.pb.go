...
import (
	...
	v2 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2"
...
const file_envoy_config_common_dynamic_forward_proxy_v2alpha_dns_cache_proto_rawDesc = "" +
	...
	"\x18dns_failure_refresh_rate\x18\x06 \x01(\v2!.envoy.api.v2.Cluster.RefreshRateR\x15dnsFailureRefreshRateB\xfc\x01\xf2\x98\xfe\x8f\x052\x120envoy.extensions.common.dynamic_forward_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"?io.envoyproxy.envoy.config.common.dynamic_forward_proxy.v2alphaB\rDnsCacheProtoP\x01Zhgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/common/dynamic_forward_proxy/v2alphab\x06proto3"
