...
const file_envoy_config_common_mutation_rules_v3_mutation_rules_proto_rawDesc = "" +
	...
	"keyMatcherB\r\n" +
	"\x06action\x12\x03\xf8B\x01B\xc2\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"3io.envoyproxy.envoy.config.common.mutation_rules.v3B\x12MutationRulesProtoP\x01Zmgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/common/mutation_rules/v3;mutation_rulesv3b\x06proto3"
