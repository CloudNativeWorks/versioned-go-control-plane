...
const file_envoy_config_common_key_value_v3_config_proto_rawDesc = "" +
	...
	".io.envoyproxy.envoy.config.common.key_value.v3B\vConfigProtoP\x01ZSgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/common/key_value/v3;key_valuev3b\x06proto3"
