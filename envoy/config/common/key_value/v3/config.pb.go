...
const file_envoy_config_common_key_value_v3_config_proto_rawDesc = "" +
	...
	"\x06config\x18\x01 \x01(\v2*.envoy.config.core.v3.TypedExtensionConfigB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x06config:\b\xd2Ƥ\xe1\x06\x02\b\x01B\xac\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	".io.envoyproxy.envoy.config.common.key_value.v3B\vConfigProtoP\x01Zcgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/common/key_value/v3;key_valuev3b\x06proto3"
