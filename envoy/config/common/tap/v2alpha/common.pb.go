...
const file_envoy_config_common_tap_v2alpha_common_proto_rawDesc = "" +
	...
	"-io.envoyproxy.envoy.config.common.tap.v2alphaB\vCommonProtoP\x01ZFgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/common/tap/v2alphab\x06proto3"
