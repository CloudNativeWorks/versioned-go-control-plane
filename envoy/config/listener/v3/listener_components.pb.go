...
const file_envoy_config_listener_v3_listener_components_proto_rawDesc = "" +
	...
	"\vconfig_typeJ\x04\b\x02\x10\x03R\x06configB\xa7\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"&io.envoyproxy.envoy.config.listener.v3B\x17ListenerComponentsProtoP\x01ZZgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/listener/v3;listenerv3b\x06proto3"
