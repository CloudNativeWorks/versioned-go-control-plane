...
const file_envoy_config_listener_v3_listener_components_proto_rawDesc = "" +
	...
	"&io.envoyproxy.envoy.config.listener.v3B\x17ListenerComponentsProtoP\x01ZJgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/listener/v3;listenerv3b\x06proto3"
