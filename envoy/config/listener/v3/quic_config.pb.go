...
const file_envoy_config_listener_v3_quic_config_proto_rawDesc = "" +
	...
	")envoy.api.v2.listener.QuicProtocolOptionsB\x9f\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"&io.envoyproxy.envoy.config.listener.v3B\x0fQuicConfigProtoP\x01ZZgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/listener/v3;listenerv3b\x06proto3"
