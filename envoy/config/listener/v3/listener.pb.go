...
const file_envoy_config_listener_v3_listener_proto_rawDesc = "" +
	...
	"&io.envoyproxy.envoy.config.listener.v3B\rListenerProtoP\x01ZJgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/listener/v3;listenerv3b\x06proto3"
