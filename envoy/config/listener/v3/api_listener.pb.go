...
const file_envoy_config_listener_v3_api_listener_proto_rawDesc = "" +
	...
	"$envoy.config.listener.v2.ApiListenerB\xa0\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"&io.envoyproxy.envoy.config.listener.v3B\x10ApiListenerProtoP\x01ZZgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/listener/v3;listenerv3b\x06proto3"
