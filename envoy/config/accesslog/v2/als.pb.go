...
const file_envoy_config_accesslog_v2_als_proto_rawDesc = "" +
	...
	"'io.envoyproxy.envoy.config.accesslog.v2B\bAlsProtoP\x01ZLgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/accesslog/v2;accesslogv2b\x06proto3"
