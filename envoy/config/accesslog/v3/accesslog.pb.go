...
const file_envoy_config_accesslog_v3_accesslog_proto_rawDesc = "" +
	...
	"'io.envoyproxy.envoy.config.accesslog.v3B\x0eAccesslogProtoP\x01ZLgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/accesslog/v3;accesslogv3b\x06proto3"
