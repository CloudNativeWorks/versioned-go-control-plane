...
const file_envoy_config_filter_accesslog_v2_accesslog_proto_rawDesc = "" +
	...
	"\vconfig_typeB\xd0\x01\xf2\x98\xfe\x8f\x05\x1b\x12\x19envoy.config.accesslog.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	".io.envoyproxy.envoy.config.filter.accesslog.v2B\x0eAccesslogProtoP\x01Zcgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/accesslog/v2;accesslogv2b\x06proto3"
