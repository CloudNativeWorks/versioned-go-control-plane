...
const file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\xea\x01\xf2\x98\xfe\x8f\x05,\x12*envoy.extensions.filters.http.ext_authz.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"3io.envoyproxy.envoy.config.filter.http.ext_authz.v2B\rExtAuthzProtoP\x01Zhgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/ext_authz/v2;ext_authzv2b\x06proto3"
