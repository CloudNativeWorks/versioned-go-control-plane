...
const file_envoy_config_filter_http_ext_authz_v2_ext_authz_proto_rawDesc = "" +
	...
	"3io.envoyproxy.envoy.config.filter.http.ext_authz.v2B\rExtAuthzProtoP\x01ZXgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/ext_authz/v2;ext_authzv2b\x06proto3"
