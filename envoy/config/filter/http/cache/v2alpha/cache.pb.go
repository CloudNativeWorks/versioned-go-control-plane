...
const file_envoy_config_filter_http_cache_v2alpha_cache_proto_rawDesc = "" +
	...
	"\x19query_parameters_excluded\x18\x04 \x03(\v2).envoy.api.v2.route.QueryParameterMatcherR\x17queryParametersExcludedB\xe0\x01\xf2\x98\xfe\x8f\x05-\x12+envoy.extensions.filters.http.cache.v3alpha\xba\x80\xc8\xd1\x06\x04\b\x01\x10\x01\n" +
	"4io.envoyproxy.envoy.config.filter.http.cache.v2alphaB\n" +
	"CacheProtoP\x01Z]github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/cache/v2alphab\x06proto3"
