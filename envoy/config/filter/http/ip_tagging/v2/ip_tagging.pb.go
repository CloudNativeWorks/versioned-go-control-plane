...
const file_envoy_config_filter_http_ip_tagging_v2_ip_tagging_proto_rawDesc = "" +
	...
	"4io.envoyproxy.envoy.config.filter.http.ip_tagging.v2B\x0eIpTaggingProtoP\x01ZZgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/ip_tagging/v2;ip_taggingv2b\x06proto3"
