...
const file_envoy_config_filter_http_ip_tagging_v2_ip_tagging_proto_rawDesc = "" +
	...
	"\bEXTERNAL\x10\x02B\xef\x01\xf2\x98\xfe\x8f\x05-\x12+envoy.extensions.filters.http.ip_tagging.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"4io.envoyproxy.envoy.config.filter.http.ip_tagging.v2B\x0eIpTaggingProtoP\x01Zjgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/ip_tagging/v2;ip_taggingv2b\x06proto3"
