...
const file_envoy_config_filter_http_rate_limit_v2_rate_limit_proto_rawDesc = "" +
	...
	"\x12rate_limit_service\x18\a \x01(\v21.envoy.config.ratelimit.v2.RateLimitServiceConfigB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x10rateLimitServiceB\xee\x01\xf2\x98\xfe\x8f\x05,\x12*envoy.extensions.filters.http.ratelimit.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"4io.envoyproxy.envoy.config.filter.http.rate_limit.v2B\x0eRateLimitProtoP\x01Zjgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/rate_limit/v2;rate_limitv2b\x06proto3"
