...
const file_envoy_config_filter_http_rate_limit_v2_rate_limit_proto_rawDesc = "" +
	...
	"4io.envoyproxy.envoy.config.filter.http.rate_limit.v2B\x0eRateLimitProtoP\x01ZZgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/rate_limit/v2;rate_limitv2b\x06proto3"
