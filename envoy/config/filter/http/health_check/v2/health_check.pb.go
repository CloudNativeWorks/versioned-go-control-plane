...
const file_envoy_config_filter_http_health_check_v2_health_check_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x13.envoy.type.PercentR\x05value:\x028\x01J\x04\b\x02\x10\x03B\xf9\x01\xf2\x98\xfe\x8f\x05/\x12-envoy.extensions.filters.http.health_check.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"6io.envoyproxy.envoy.config.filter.http.health_check.v2B\x10HealthCheckProtoP\x01Zngithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/health_check/v2;health_checkv2b\x06proto3"
