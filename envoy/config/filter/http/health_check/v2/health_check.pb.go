...
const file_envoy_config_filter_http_health_check_v2_health_check_proto_rawDesc = "" +
	...
	"6io.envoyproxy.envoy.config.filter.http.health_check.v2B\x10HealthCheckProtoP\x01Z^github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/health_check/v2;health_checkv2b\x06proto3"
