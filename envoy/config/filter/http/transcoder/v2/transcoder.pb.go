...
const file_envoy_config_filter_http_transcoder_v2_transcoder_proto_rawDesc = "" +
	...
	"4io.envoyproxy.envoy.config.filter.http.transcoder.v2B\x0fTranscoderProtoP\x01ZZgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/transcoder/v2;transcoderv2b\x06proto3"
