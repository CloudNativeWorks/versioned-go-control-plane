...
const file_envoy_config_filter_http_transcoder_v2_transcoder_proto_rawDesc = "" +
	...
	"\x0edescriptor_set\x12\x03\xf8B\x01B\xfa\x01\xf2\x98\xfe\x8f\x057\x125envoy.extensions.filters.http.grpc_json_transcoder.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"4io.envoyproxy.envoy.config.filter.http.transcoder.v2B\x0fTranscoderProtoP\x01Zjgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/transcoder/v2;transcoderv2b\x06proto3"
