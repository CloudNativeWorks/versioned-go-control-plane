...
const file_envoy_config_filter_http_aws_request_signing_v2alpha_aws_request_signing_proto_rawDesc = "" +
	...
	"Bio.envoyproxy.envoy.config.filter.http.aws_request_signing.v2alphaB\x16AwsRequestSigningProtoP\x01Z[github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/aws_request_signing/v2alphab\x06proto3"
