...
const file_envoy_config_filter_http_aws_request_signing_v2alpha_aws_request_signing_proto_rawDesc = "" +
	...
	"\fhost_rewrite\x18\x03 \x01(\tR\vhostRewriteB\x8f\x02\xf2\x98\xfe\x8f\x056\x124envoy.extensions.filters.http.aws_request_signing.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"Bio.envoyproxy.envoy.config.filter.http.aws_request_signing.v2alphaB\x16AwsRequestSigningProtoP\x01Zkgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/aws_request_signing/v2alphab\x06proto3"
