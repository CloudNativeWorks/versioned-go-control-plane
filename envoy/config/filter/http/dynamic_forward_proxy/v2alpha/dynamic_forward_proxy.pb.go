...
const file_envoy_config_filter_http_dynamic_forward_proxy_v2alpha_dynamic_forward_proxy_proto_rawDesc = "" +
	...
	"Dio.envoyproxy.envoy.config.filter.http.dynamic_forward_proxy.v2alphaB\x18DynamicForwardProxyProtoP\x01Z]github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/dynamic_forward_proxy/v2alphab\x06proto3"
