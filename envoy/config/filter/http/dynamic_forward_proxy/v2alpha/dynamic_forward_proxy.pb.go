...
const file_envoy_config_filter_http_dynamic_forward_proxy_v2alpha_dynamic_forward_proxy_proto_rawDesc = "" +
	...
	"\x16host_rewrite_specifierB\x97\x02\xf2\x98\xfe\x8f\x058\x126envoy.extensions.filters.http.dynamic_forward_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"Dio.envoyproxy.envoy.config.filter.http.dynamic_forward_proxy.v2alphaB\x18DynamicForwardProxyProtoP\x01Zmgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/dynamic_forward_proxy/v2alphab\x06proto3"
