...
const file_envoy_config_filter_http_adaptive_concurrency_v2alpha_adaptive_concurrency_proto_rawDesc = "" +
	...
	"\x1dconcurrency_controller_config\x12\x03\xf8B\x01B\x94\x02\xf2\x98\xfe\x8f\x057\x125envoy.extensions.filters.http.adaptive_concurrency.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"Cio.envoyproxy.envoy.config.filter.http.adaptive_concurrency.v2alphaB\x18AdaptiveConcurrencyProtoP\x01Zlgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/adaptive_concurrency/v2alphab\x06proto3"
