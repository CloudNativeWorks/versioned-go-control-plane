...
const file_envoy_config_filter_http_adaptive_concurrency_v2alpha_adaptive_concurrency_proto_rawDesc = "" +
	...
	"Cio.envoyproxy.envoy.config.filter.http.adaptive_concurrency.v2alphaB\x18AdaptiveConcurrencyProtoP\x01Z\\github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/adaptive_concurrency/v2alphab\x06proto3"
