...
const file_envoy_config_filter_http_header_to_metadata_v2_header_to_metadata_proto_rawDesc = "" +
	...
	"\x04NONE\x10\x00\x12\n" +
	"\n" +
	"\x06BASE64\x10\x01B\x96\x02\xf2\x98\xfe\x8f\x055\x123envoy.extensions.filters.http.header_to_metadata.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"<io.envoyproxy.envoy.config.filter.http.header_to_metadata.v2B\x15HeaderToMetadataProtoP\x01Zzgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/header_to_metadata/v2;header_to_metadatav2b\x06proto3"
