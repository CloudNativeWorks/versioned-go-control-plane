...
const file_envoy_config_filter_http_header_to_metadata_v2_header_to_metadata_proto_rawDesc = "" +
	...
	"<io.envoyproxy.envoy.config.filter.http.header_to_metadata.v2B\x15HeaderToMetadataProtoP\x01Zjgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/header_to_metadata/v2;header_to_metadatav2b\x06proto3"
