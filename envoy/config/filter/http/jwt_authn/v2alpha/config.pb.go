...
const file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDesc = "" +
	...
	"8io.envoyproxy.envoy.config.filter.http.jwt_authn.v2alphaB\vConfigProtoP\x01ZQgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/jwt_authn/v2alphab\x06proto3"
