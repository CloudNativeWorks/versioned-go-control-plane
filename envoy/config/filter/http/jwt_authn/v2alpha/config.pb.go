...
const file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v27.envoy.config.filter.http.jwt_authn.v2alpha.JwtProviderR\x05value:\x028\x01B\xe6\x01\xf2\x98\xfe\x8f\x05,\x12*envoy.extensions.filters.http.jwt_authn.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"8io.envoyproxy.envoy.config.filter.http.jwt_authn.v2alphaB\vConfigProtoP\x01Zagithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/jwt_authn/v2alphab\x06proto3"
