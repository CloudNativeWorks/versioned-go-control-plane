...
const file_envoy_config_filter_http_grpc_http1_reverse_bridge_v2alpha1_config_proto_rawDesc = "" +
	...
	"Iio.envoyproxy.envoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1B\vConfigProtoP\x01Zbgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/grpc_http1_reverse_bridge/v2alpha1b\x06proto3"
