...
const file_envoy_config_filter_http_grpc_http1_reverse_bridge_v2alpha1_config_proto_rawDesc = "" +
	...
	"\bdisabled\x18\x01 \x01(\bR\bdisabledB\x98\x02\xf2\x98\xfe\x8f\x05<\x12:envoy.extensions.filters.http.grpc_http1_reverse_bridge.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"Iio.envoyproxy.envoy.config.filter.http.grpc_http1_reverse_bridge.v2alpha1B\vConfigProtoP\x01Zrgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/grpc_http1_reverse_bridge/v2alpha1b\x06proto3"
