...
const file_envoy_config_filter_http_csrf_v2_csrf_proto_rawDesc = "" +
	...
	"\x12additional_origins\x18\x03 \x03(\v2!.envoy.type.matcher.StringMatcherR\x11additionalOriginsB\xd2\x01\xf2\x98\xfe\x8f\x05'\x12%envoy.extensions.filters.http.csrf.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	".io.envoyproxy.envoy.config.filter.http.csrf.v2B\tCsrfProtoP\x01Z^github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/csrf/v2;csrfv2b\x06proto3"
