...
const file_envoy_config_filter_http_csrf_v2_csrf_proto_rawDesc = "" +
	...
	".io.envoyproxy.envoy.config.filter.http.csrf.v2B\tCsrfProtoP\x01ZNgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/csrf/v2;csrfv2b\x06proto3"
