...
const file_envoy_config_filter_http_compressor_v2_compressor_proto_rawDesc = "" +
	...
	"\x0fruntime_enabled\x18\x05 \x01(\v2%.envoy.api.v2.core.RuntimeFeatureFlagR\x0eruntimeEnabledB\xf0\x01\xf2\x98\xfe\x8f\x05-\x12+envoy.extensions.filters.http.compressor.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"4io.envoyproxy.envoy.config.filter.http.compressor.v2B\x0fCompressorProtoP\x01Zjgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/compressor/v2;compressorv2b\x06proto3"
