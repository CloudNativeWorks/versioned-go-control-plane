...
const file_envoy_config_filter_http_compressor_v2_compressor_proto_rawDesc = "" +
	...
	"4io.envoyproxy.envoy.config.filter.http.compressor.v2B\x0fCompressorProtoP\x01ZZgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/compressor/v2;compressorv2b\x06proto3"
