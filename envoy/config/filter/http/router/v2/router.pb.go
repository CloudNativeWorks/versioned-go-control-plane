...
const file_envoy_config_filter_http_router_v2_router_proto_rawDesc = "" +
	...
	"0io.envoyproxy.envoy.config.filter.http.router.v2B\vRouterProtoP\x01ZRgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/router/v2;routerv2b\x06proto3"
