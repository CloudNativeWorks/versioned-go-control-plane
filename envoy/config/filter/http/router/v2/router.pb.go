...
const file_envoy_config_filter_http_router_v2_router_proto_rawDesc = "" +
	...
	"\x1brespect_expected_rq_timeout\x18\x06 \x01(\bR\x18respectExpectedRqTimeoutB\xdc\x01\xf2\x98\xfe\x8f\x05)\x12'envoy.extensions.filters.http.router.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"0io.envoyproxy.envoy.config.filter.http.router.v2B\vRouterProtoP\x01Zbgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/router/v2;routerv2b\x06proto3"
