...
const file_envoy_config_filter_http_grpc_stats_v2alpha_config_proto_rawDesc = "" +
	...
	"\x16response_message_count\x18\x02 \x01(\x04R\x14responseMessageCountB\xe9\x01\xf2\x98\xfe\x8f\x05-\x12+envoy.extensions.filters.http.grpc_stats.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"9io.envoyproxy.envoy.config.filter.http.grpc_stats.v2alphaB\vConfigProtoP\x01Zbgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/grpc_stats/v2alphab\x06proto3"
