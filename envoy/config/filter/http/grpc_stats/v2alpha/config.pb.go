...
const file_envoy_config_filter_http_grpc_stats_v2alpha_config_proto_rawDesc = "" +
	...
	"9io.envoyproxy.envoy.config.filter.http.grpc_stats.v2alphaB\vConfigProtoP\x01ZRgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/grpc_stats/v2alphab\x06proto3"
