...
import (
	...
	v2 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/compressor/v2"
...
const file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDesc = "" +
	...
	"\x03RLE\x10\x03B\xd2\x01\xf2\x98\xfe\x8f\x05'\x12%envoy.extensions.filters.http.gzip.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	".io.envoyproxy.envoy.config.filter.http.gzip.v2B\tGzipProtoP\x01Z^github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/gzip/v2;gzipv2b\x06proto3"
