...
const file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDesc = "" +
	...
	".io.envoyproxy.envoy.config.filter.http.gzip.v2B\tGzipProtoP\x01ZNgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/gzip/v2;gzipv2b\x06proto3"
