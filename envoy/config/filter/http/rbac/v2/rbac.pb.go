...
import (
	...
	v2 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/rbac/v2"
...
const file_envoy_config_filter_http_rbac_v2_rbac_proto_rawDesc = "" +
	...
	"\fRBACPerRoute\x12:\n" +
	"\x04rbac\x18\x02 \x01(\v2&.envoy.config.filter.http.rbac.v2.RBACR\x04rbacJ\x04\b\x01\x10\x02B\xd2\x01\xf2\x98\xfe\x8f\x05'\x12%envoy.extensions.filters.http.rbac.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	".io.envoyproxy.envoy.config.filter.http.rbac.v2B\tRbacProtoP\x01Z^github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/rbac/v2;rbacv2b\x06proto3"
