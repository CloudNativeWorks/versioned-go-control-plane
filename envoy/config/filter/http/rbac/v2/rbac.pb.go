...
const file_envoy_config_filter_http_rbac_v2_rbac_proto_rawDesc = "" +
	...
	".io.envoyproxy.envoy.config.filter.http.rbac.v2B\tRbacProtoP\x01ZNgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/rbac/v2;rbacv2b\x06proto3"
