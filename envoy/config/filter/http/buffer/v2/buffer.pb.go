...
const file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDesc = "" +
	...
	"\boverride\x12\x03\xf8B\x01B\xdc\x01\xf2\x98\xfe\x8f\x05)\x12'envoy.extensions.filters.http.buffer.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"0io.envoyproxy.envoy.config.filter.http.buffer.v2B\vBufferProtoP\x01Zbgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/buffer/v2;bufferv2b\x06proto3"
