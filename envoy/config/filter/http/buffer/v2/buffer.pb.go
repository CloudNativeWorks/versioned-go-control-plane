...
const file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDesc = "" +
	...
	"0io.envoyproxy.envoy.config.filter.http.buffer.v2B\vBufferProtoP\x01ZRgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/buffer/v2;bufferv2b\x06proto3"
