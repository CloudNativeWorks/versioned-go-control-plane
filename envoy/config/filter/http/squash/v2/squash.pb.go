...
const file_envoy_config_filter_http_squash_v2_squash_proto_rawDesc = "" +
	...
	"0io.envoyproxy.envoy.config.filter.http.squash.v2B\vSquashProtoP\x01ZRgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/squash/v2;squashv2b\x06proto3"
