...
const file_envoy_config_filter_http_squash_v2_squash_proto_rawDesc = "" +
	...
	"\x16attachment_poll_period\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\x14attachmentPollPeriodB\xdc\x01\xf2\x98\xfe\x8f\x05)\x12'envoy.extensions.filters.http.squash.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"0io.envoyproxy.envoy.config.filter.http.squash.v2B\vSquashProtoP\x01Zbgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/squash/v2;squashv2b\x06proto3"
