...
import (
	...
	v2 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/fault/v2"
...
const file_envoy_config_filter_http_fault_v2_fault_proto_rawDesc = "" +
	...
	"#response_rate_limit_percent_runtime\x18\r \x01(\tR\x1fresponseRateLimitPercentRuntimeB\xd7\x01\xf2\x98\xfe\x8f\x05(\x12&envoy.extensions.filters.http.fault.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"/io.envoyproxy.envoy.config.filter.http.fault.v2B\n" +
	"FaultProtoP\x01Z`github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/fault/v2;faultv2b\x06proto3"
