...
const file_envoy_config_filter_http_on_demand_v2_on_demand_proto_rawDesc = "" +
	...
	"\n" +
	"\bOnDemandB\xea\x01\xf2\x98\xfe\x8f\x05,\x12*envoy.extensions.filters.http.on_demand.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"3io.envoyproxy.envoy.config.filter.http.on_demand.v2B\rOnDemandProtoP\x01Zhgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/on_demand/v2;on_demandv2b\x06proto3"
