...
const file_envoy_config_filter_http_on_demand_v2_on_demand_proto_rawDesc = "" +
	...
	"3io.envoyproxy.envoy.config.filter.http.on_demand.v2B\rOnDemandProtoP\x01ZXgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/http/on_demand/v2;on_demandv2b\x06proto3"
