...
const file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDesc = "" +
	...
	"7io.envoyproxy.envoy.config.filter.dubbo.router.v2alpha1B\vRouterProtoP\x01ZPgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/dubbo/router/v2alpha1b\x06proto3"
