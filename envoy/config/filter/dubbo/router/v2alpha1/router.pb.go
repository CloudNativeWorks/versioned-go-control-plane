...
const file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDesc = "" +
	...
	"\x06RouterB\xf0\x01\xf2\x98\xfe\x8f\x058\x126envoy.extensions.filters.network.dubbo_proxy.router.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"7io.envoyproxy.envoy.config.filter.dubbo.router.v2alpha1B\vRouterProtoP\x01Z`github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/dubbo/router/v2alpha1b\x06proto3"
