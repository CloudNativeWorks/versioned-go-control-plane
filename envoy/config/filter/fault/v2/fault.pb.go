...
const file_envoy_config_filter_fault_v2_fault_proto_rawDesc = "" +
	...
	"\vHeaderLimitB\x11\n" +
	"\n" +
	"limit_type\x12\x03\xf8B\x01B\xcf\x01\xf2\x98\xfe\x8f\x05*\x12(envoy.extensions.filters.common.fault.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"*io.envoyproxy.envoy.config.filter.fault.v2B\n" +
	"FaultProtoP\x01Z[github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/fault/v2;faultv2b\x06proto3"
