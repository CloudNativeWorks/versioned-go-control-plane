...
const file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy_proto_rawDesc = "" +
	...
	"\x11cluster_specifier\x12\x03\xf8B\x01B\xf3\x01\xf2\x98\xfe\x8f\x05/\x12-envoy.extensions.filters.network.tcp_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"6io.envoyproxy.envoy.config.filter.network.tcp_proxy.v2B\rTcpProxyProtoP\x01Zkgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/tcp_proxy/v2;tcp_proxyv2b\x06proto3"
