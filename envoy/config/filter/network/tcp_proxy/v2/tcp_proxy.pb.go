...
const file_envoy_config_filter_network_tcp_proxy_v2_tcp_proxy_proto_rawDesc = "" +
	...
	"6io.envoyproxy.envoy.config.filter.network.tcp_proxy.v2B\rTcpProxyProtoP\x01Z[github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/tcp_proxy/v2;tcp_proxyv2b\x06proto3"
