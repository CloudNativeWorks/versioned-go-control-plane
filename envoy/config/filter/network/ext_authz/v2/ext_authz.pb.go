...
const file_envoy_config_filter_network_ext_authz_v2_ext_authz_proto_rawDesc = "" +
	...
	"\x18include_peer_certificate\x18\x04 \x01(\bR\x16includePeerCertificateB\xf3\x01\xf2\x98\xfe\x8f\x05/\x12-envoy.extensions.filters.network.ext_authz.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"6io.envoyproxy.envoy.config.filter.network.ext_authz.v2B\rExtAuthzProtoP\x01Zkgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/ext_authz/v2;ext_authzv2b\x06proto3"
