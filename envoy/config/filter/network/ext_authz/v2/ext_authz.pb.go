...
const file_envoy_config_filter_network_ext_authz_v2_ext_authz_proto_rawDesc = "" +
	...
	"6io.envoyproxy.envoy.config.filter.network.ext_authz.v2B\rExtAuthzProtoP\x01Z[github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/ext_authz/v2;ext_authzv2b\x06proto3"
