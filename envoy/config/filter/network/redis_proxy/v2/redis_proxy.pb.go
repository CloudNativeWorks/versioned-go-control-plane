...
const file_envoy_config_filter_network_redis_proxy_v2_redis_proxy_proto_rawDesc = "" +
	...
	"8io.envoyproxy.envoy.config.filter.network.redis_proxy.v2B\x0fRedisProxyProtoP\x01Z_github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/redis_proxy/v2;redis_proxyv2b\x06proto3"
