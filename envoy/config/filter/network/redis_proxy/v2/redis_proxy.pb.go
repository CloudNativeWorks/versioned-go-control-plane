...
const file_envoy_config_filter_network_redis_proxy_v2_redis_proxy_proto_rawDesc = "" +
	...
	"\rauth_password\x18\x01 \x01(\v2\x1d.envoy.api.v2.core.DataSourceB\x06\xb8\xb7\x8b\xa4\x02\x01R\fauthPasswordB\xfd\x01\xf2\x98\xfe\x8f\x051\x12/envoy.extensions.filters.network.redis_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"8io.envoyproxy.envoy.config.filter.network.redis_proxy.v2B\x0fRedisProxyProtoP\x01Zogithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/redis_proxy/v2;redis_proxyv2b\x06proto3"
