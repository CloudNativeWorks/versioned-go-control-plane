...
const file_envoy_config_filter_network_thrift_proxy_v2alpha1_route_proto_rawDesc = "" +
	...
	"\x0emetadata_match\x18\x03 \x01(\v2\x1b.envoy.api.v2.core.MetadataR\rmetadataMatchB\xf9\x01\xf2\x98\xfe\x8f\x052\x120envoy.extensions.filters.network.thrift_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"?io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1B\n" +
	"RouteProtoP\x01Zhgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/thrift_proxy/v2alpha1b\x06proto3"
