...
const file_envoy_config_filter_network_thrift_proxy_v2alpha1_thrift_proxy_proto_rawDesc = "" +
	...
	"\aTWITTER\x10\x04B\xff\x01\xf2\x98\xfe\x8f\x052\x120envoy.extensions.filters.network.thrift_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"?io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1B\x10ThriftProxyProtoP\x01Zhgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/thrift_proxy/v2alpha1b\x06proto3"
