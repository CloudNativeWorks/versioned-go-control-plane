...
const file_envoy_config_filter_network_thrift_proxy_v2alpha1_thrift_proxy_proto_rawDesc = "" +
	...
	"?io.envoyproxy.envoy.config.filter.network.thrift_proxy.v2alpha1B\x10ThriftProxyProtoP\x01ZXgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/thrift_proxy/v2alpha1b\x06proto3"
