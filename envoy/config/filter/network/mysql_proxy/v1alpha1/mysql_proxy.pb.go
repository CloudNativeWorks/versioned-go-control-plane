...
const file_envoy_config_filter_network_mysql_proxy_v1alpha1_mysql_proxy_proto_rawDesc = "" +
	...
	">io.envoyproxy.envoy.config.filter.network.mysql_proxy.v1alpha1B\x0fMysqlProxyProtoP\x01ZWgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/mysql_proxy/v1alpha1b\x06proto3"
