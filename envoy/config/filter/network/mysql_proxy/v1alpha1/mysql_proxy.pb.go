...
const file_envoy_config_filter_network_mysql_proxy_v1alpha1_mysql_proxy_proto_rawDesc = "" +
	...
	"statPrefix\x12\x1d\n" +
	"\n" +
	"access_log\x18\x02 \x01(\tR\taccessLogB\xfb\x01\xf2\x98\xfe\x8f\x051\x12/envoy.extensions.filters.network.mysql_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	">io.envoyproxy.envoy.config.filter.network.mysql_proxy.v1alpha1B\x0fMysqlProxyProtoP\x01Zggithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/mysql_proxy/v1alpha1b\x06proto3"
