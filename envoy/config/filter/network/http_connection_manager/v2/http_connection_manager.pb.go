...
import (
	...
	v21 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2"
	core "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/core"
	v2 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/accesslog/v2"
	v23 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v2"
	_type "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/type"
	v22 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/type/tracing/v2"
...
const file_envoy_config_filter_network_http_connection_manager_v2_http_connection_manager_proto_rawDesc = "" +
	...
	"\ftyped_config\x18\x01 \x01(\v2\x14.google.protobuf.AnyR\vtypedConfigB\xb9\x02\xf2\x98\xfe\x8f\x05=\x12;envoy.extensions.filters.network.http_connection_manager.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"Dio.envoyproxy.envoy.config.filter.network.http_connection_manager.v2B\x1aHttpConnectionManagerProtoP\x01Z\x87\x01github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/http_connection_manager/v2;http_connection_managerv2b\x06proto3"
