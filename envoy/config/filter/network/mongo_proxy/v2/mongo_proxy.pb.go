...
const file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDesc = "" +
	...
	"\x15emit_dynamic_metadata\x18\x04 \x01(\bR\x13emitDynamicMetadataB\xfd\x01\xf2\x98\xfe\x8f\x051\x12/envoy.extensions.filters.network.mongo_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"8io.envoyproxy.envoy.config.filter.network.mongo_proxy.v2B\x0fMongoProxyProtoP\x01Zogithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/mongo_proxy/v2;mongo_proxyv2b\x06proto3"
