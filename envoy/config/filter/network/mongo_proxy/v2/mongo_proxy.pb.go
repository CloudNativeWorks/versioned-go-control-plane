...
const file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDesc = "" +
	...
	"8io.envoyproxy.envoy.config.filter.network.mongo_proxy.v2B\x0fMongoProxyProtoP\x01Z_github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/mongo_proxy/v2;mongo_proxyv2b\x06proto3"
