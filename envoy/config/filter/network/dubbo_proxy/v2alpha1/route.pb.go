...
import (
	...
	route "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/route"
...
const file_envoy_config_filter_network_dubbo_proxy_v2alpha1_route_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2U.envoy.config.filter.network.dubbo_proxy.v2alpha1.MethodMatch.ParameterMatchSpecifierR\x05value:\x028\x01B\xf6\x01\xf2\x98\xfe\x8f\x051\x12/envoy.extensions.filters.network.dubbo_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	">io.envoyproxy.envoy.config.filter.network.dubbo_proxy.v2alpha1B\n" +
	"RouteProtoP\x01Zggithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/dubbo_proxy/v2alpha1b\x06proto3"
