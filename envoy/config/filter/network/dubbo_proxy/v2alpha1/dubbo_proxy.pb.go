...
const file_envoy_config_filter_network_dubbo_proxy_v2alpha1_dubbo_proxy_proto_rawDesc = "" +
	...
	"\bHessian2\x10\x00B\xfb\x01\xf2\x98\xfe\x8f\x051\x12/envoy.extensions.filters.network.dubbo_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	">io.envoyproxy.envoy.config.filter.network.dubbo_proxy.v2alpha1B\x0fDubboProxyProtoP\x01Zggithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/dubbo_proxy/v2alpha1b\x06proto3"
