...
const file_envoy_config_filter_network_dubbo_proxy_v2alpha1_dubbo_proxy_proto_rawDesc = "" +
	...
	">io.envoyproxy.envoy.config.filter.network.dubbo_proxy.v2alpha1B\x0fDubboProxyProtoP\x01ZWgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/dubbo_proxy/v2alpha1b\x06proto3"
