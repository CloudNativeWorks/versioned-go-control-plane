...
const file_envoy_config_filter_network_local_rate_limit_v2alpha_local_rate_limit_proto_rawDesc = "" +
	...
	"Bio.envoyproxy.envoy.config.filter.network.local_rate_limit.v2alphaB\x13LocalRateLimitProtoP\x01Z[github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/local_rate_limit/v2alphab\x06proto3"
