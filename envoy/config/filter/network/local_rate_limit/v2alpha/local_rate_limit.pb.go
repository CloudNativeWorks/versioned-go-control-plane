...
const file_envoy_config_filter_network_local_rate_limit_v2alpha_local_rate_limit_proto_rawDesc = "" +
	...
	"\x0fruntime_enabled\x18\x03 \x01(\v2%.envoy.api.v2.core.RuntimeFeatureFlagR\x0eruntimeEnabledB\x8b\x02\xf2\x98\xfe\x8f\x055\x123envoy.extensions.filters.network.local_ratelimit.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"Bio.envoyproxy.envoy.config.filter.network.local_rate_limit.v2alphaB\x13LocalRateLimitProtoP\x01Zkgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/local_rate_limit/v2alphab\x06proto3"
