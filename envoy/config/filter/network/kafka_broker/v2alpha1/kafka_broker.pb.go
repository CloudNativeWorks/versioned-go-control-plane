...
const file_envoy_config_filter_network_kafka_broker_v2alpha1_kafka_broker_proto_rawDesc = "" +
	...
	"?io.envoyproxy.envoy.config.filter.network.kafka_broker.v2alpha1B\x10KafkaBrokerProtoP\x01ZXgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/kafka_broker/v2alpha1b\x06proto3"
