...
const file_envoy_config_filter_network_kafka_broker_v2alpha1_kafka_broker_proto_rawDesc = "" +
	...
	"\x04port\x18\x03 \x01(\rB\t\xfaB\x06*\x04\x18\xff\xff\x03R\x04portB\xff\x01\xf2\x98\xfe\x8f\x052\x120envoy.extensions.filters.network.kafka_broker.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"?io.envoyproxy.envoy.config.filter.network.kafka_broker.v2alpha1B\x10KafkaBrokerProtoP\x01Zhgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/kafka_broker/v2alpha1b\x06proto3"
