...
const file_envoy_config_filter_network_zookeeper_proxy_v1alpha1_zookeeper_proxy_proto_rawDesc = "" +
	...
	"\x10max_packet_bytes\x18\x03 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x0emaxPacketBytesB\x8b\x02\xf2\x98\xfe\x8f\x055\x123envoy.extensions.filters.network.zookeeper_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"Bio.envoyproxy.envoy.config.filter.network.zookeeper_proxy.v1alpha1B\x13ZookeeperProxyProtoP\x01Zkgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/zookeeper_proxy/v1alpha1b\x06proto3"
