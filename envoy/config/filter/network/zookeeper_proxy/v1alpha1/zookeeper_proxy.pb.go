...
const file_envoy_config_filter_network_zookeeper_proxy_v1alpha1_zookeeper_proxy_proto_rawDesc = "" +
	...
	"Bio.envoyproxy.envoy.config.filter.network.zookeeper_proxy.v1alpha1B\x13ZookeeperProxyProtoP\x01Z[github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/zookeeper_proxy/v1alpha1b\x06proto3"
