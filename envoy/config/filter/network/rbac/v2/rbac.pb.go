...
const file_envoy_config_filter_network_rbac_v2_rbac_proto_rawDesc = "" +
	...
	"1io.envoyproxy.envoy.config.filter.network.rbac.v2B\tRbacProtoP\x01ZQgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/rbac/v2;rbacv2b\x06proto3"
