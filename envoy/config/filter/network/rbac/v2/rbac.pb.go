...
const file_envoy_config_filter_network_rbac_v2_rbac_proto_rawDesc = "" +
	...
	"\n" +
	"CONTINUOUS\x10\x01B\xdb\x01\xf2\x98\xfe\x8f\x05*\x12(envoy.extensions.filters.network.rbac.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"1io.envoyproxy.envoy.config.filter.network.rbac.v2B\tRbacProtoP\x01Zagithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/network/rbac/v2;rbacv2b\x06proto3"
