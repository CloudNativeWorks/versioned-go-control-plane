...
const file_envoy_config_filter_listener_proxy_protocol_v2_proxy_protocol_proto_rawDesc = "" +
	...
	"<io.envoyproxy.envoy.config.filter.listener.proxy_protocol.v2B\x12ProxyProtocolProtoP\x01Zfgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/listener/proxy_protocol/v2;proxy_protocolv2b\x06proto3"
