...
const file_envoy_config_filter_listener_proxy_protocol_v2_proxy_protocol_proto_rawDesc = "" +
	...
	"\rProxyProtocolB\x8f\x02\xf2\x98\xfe\x8f\x055\x123envoy.extensions.filters.listener.proxy_protocol.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"<io.envoyproxy.envoy.config.filter.listener.proxy_protocol.v2B\x12ProxyProtocolProtoP\x01Zvgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/listener/proxy_protocol/v2;proxy_protocolv2b\x06proto3"
