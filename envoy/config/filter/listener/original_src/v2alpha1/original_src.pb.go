...
const file_envoy_config_filter_listener_original_src_v2alpha1_original_src_proto_rawDesc = "" +
	...
	"\x04mark\x18\x02 \x01(\rR\x04markB\x82\x02\xf2\x98\xfe\x8f\x053\x121envoy.extensions.filters.listener.original_src.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"@io.envoyproxy.envoy.config.filter.listener.original_src.v2alpha1B\x10OriginalSrcProtoP\x01Zigithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/filter/listener/original_src/v2alpha1b\x06proto3"
