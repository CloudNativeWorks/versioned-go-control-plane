...
const file_envoy_config_bootstrap_v3_bootstrap_proto_rawDesc = "" +
	...
	"'io.envoyproxy.envoy.config.bootstrap.v3B\x0eBootstrapProtoP\x01ZLgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/bootstrap/v3;bootstrapv3b\x06proto3"
