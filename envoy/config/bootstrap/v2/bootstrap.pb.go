...
import (
	...
	v22 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2"
	auth "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/auth"
	core "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/api/v2/core"
	v2 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/metrics/v2"
	v2alpha "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/overload/v2alpha"
	v21 "github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/trace/v2"
...
const file_envoy_config_bootstrap_v2_bootstrap_proto_rawDesc = "" +
	...
	"\x06layers\x18\x01 \x03(\v2'.envoy.config.bootstrap.v2.RuntimeLayerR\x06layersB\xa1\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"'io.envoyproxy.envoy.config.bootstrap.v2B\x0eBootstrapProtoP\x01Z\\github.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/bootstrap/v2;bootstrapv2b\x06proto3"
