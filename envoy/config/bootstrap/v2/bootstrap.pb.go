...
const file_envoy_config_bootstrap_v2_bootstrap_proto_rawDesc = "" +
	...
	"'io.envoyproxy.envoy.config.bootstrap.v2B\x0eBootstrapProtoP\x01ZLgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/bootstrap/v2;bootstrapv2b\x06proto3"
