...
const file_envoy_config_route_v3_scoped_route_proto_rawDesc = "" +
	...
	"%envoy.api.v2.ScopedRouteConfigurationB\x97\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"#io.envoyproxy.envoy.config.route.v3B\x10ScopedRouteProtoP\x01ZTgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/route/v3;routev3b\x06proto3"
