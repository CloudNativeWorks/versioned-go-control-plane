...
const file_envoy_config_route_v3_scoped_route_proto_rawDesc = "" +
	...
	"#io.envoyproxy.envoy.config.route.v3B\x10ScopedRouteProtoP\x01ZDgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/route/v3;routev3b\x06proto3"
