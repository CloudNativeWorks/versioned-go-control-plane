...
const file_envoy_config_metrics_v2_stats_proto_rawDesc = "" +
	...
	"numBucketsB\x97\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"%io.envoyproxy.envoy.config.metrics.v2B\n" +
	"StatsProtoP\x01ZXgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/metrics/v2;metricsv2b\x06proto3"
