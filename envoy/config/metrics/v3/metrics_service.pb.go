...
const file_envoy_config_metrics_v3_metrics_service_proto_rawDesc = "" +
	...
	"%io.envoyproxy.envoy.config.metrics.v3B\x13MetricsServiceProtoP\x01ZHgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/metrics/v3;metricsv3b\x06proto3"
