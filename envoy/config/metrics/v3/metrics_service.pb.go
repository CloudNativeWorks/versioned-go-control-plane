...
const file_envoy_config_metrics_v3_metrics_service_proto_rawDesc = "" +
	...
	"\tHISTOGRAM\x10\x02B\xa0\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"%io.envoyproxy.envoy.config.metrics.v3B\x13MetricsServiceProtoP\x01ZXgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/metrics/v3;metricsv3b\x06proto3"
