...
const file_envoy_config_metrics_v3_stats_proto_rawDesc = "" +
	...
	"numBuckets:*\x9aň\x1e%\n" +
	"#envoy.config.metrics.v2.HystrixSinkB\x97\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"%io.envoyproxy.envoy.config.metrics.v3B\n" +
	"StatsProtoP\x01ZXgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/metrics/v3;metricsv3b\x06proto3"
