...
const file_envoy_config_overload_v2alpha_overload_proto_rawDesc = "" +
	...
	"+io.envoyproxy.envoy.config.overload.v2alphaB\rOverloadProtoP\x01ZDgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/overload/v2alphab\x06proto3"
