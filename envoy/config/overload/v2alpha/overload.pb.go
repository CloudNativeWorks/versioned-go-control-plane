...
const file_envoy_config_overload_v2alpha_overload_proto_rawDesc = "" +
	...
	"\aactions\x18\x03 \x03(\v2-.envoy.config.overload.v2alpha.OverloadActionR\aactionsB\x9c\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"+io.envoyproxy.envoy.config.overload.v2alphaB\rOverloadProtoP\x01ZTgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/overload/v2alphab\x06proto3"
