...
const file_envoy_config_overload_v3_overload_proto_rawDesc = "" +
	...
	"&io.envoyproxy.envoy.config.overload.v3B\rOverloadProtoP\x01ZJgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/overload/v3;overloadv3b\x06proto3"
