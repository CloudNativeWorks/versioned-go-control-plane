...
const file_envoy_config_overload_v3_overload_proto_rawDesc = "" +
	...
	"-envoy.config.overload.v2alpha.OverloadManagerB\x9d\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"&io.envoyproxy.envoy.config.overload.v3B\rOverloadProtoP\x01ZZgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/overload/v3;overloadv3b\x06proto3"
