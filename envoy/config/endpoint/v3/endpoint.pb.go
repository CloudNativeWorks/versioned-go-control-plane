...
const file_envoy_config_endpoint_v3_endpoint_proto_rawDesc = "" +
	...
	"\"envoy.api.v2.ClusterLoadAssignmentB\x9d\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"&io.envoyproxy.envoy.config.endpoint.v3B\rEndpointProtoP\x01ZZgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/endpoint/v3;endpointv3b\x06proto3"
