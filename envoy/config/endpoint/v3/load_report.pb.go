...
const file_envoy_config_endpoint_v3_load_report_proto_rawDesc = "" +
	...
	"&io.envoyproxy.envoy.config.endpoint.v3B\x0fLoadReportProtoP\x01ZJgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/endpoint/v3;endpointv3b\x06proto3"
