...
const file_envoy_config_endpoint_v3_endpoint_components_proto_rawDesc = "" +
	...
	"&io.envoyproxy.envoy.config.endpoint.v3B\x17EndpointComponentsProtoP\x01ZJgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/endpoint/v3;endpointv3b\x06proto3"
