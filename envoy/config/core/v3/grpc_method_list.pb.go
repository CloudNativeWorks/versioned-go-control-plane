...
const file_envoy_config_core_v3_grpc_method_list_proto_rawDesc = "" +
	...
	" envoy.api.v2.core.GrpcMethodListB\x97\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"\"io.envoyproxy.envoy.config.core.v3B\x13GrpcMethodListProtoP\x01ZRgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/core/v3;corev3b\x06proto3"
