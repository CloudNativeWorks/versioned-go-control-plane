...
const file_envoy_config_core_v3_socket_option_proto_rawDesc = "" +
	...
	"\x0esocket_options\x18\x01 \x03(\v2\".envoy.config.core.v3.SocketOptionR\rsocketOptionsB\x95\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"\"io.envoyproxy.envoy.config.core.v3B\x11SocketOptionProtoP\x01ZRgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/core/v3;corev3b\x06proto3"
