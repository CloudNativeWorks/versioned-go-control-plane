...
const file_envoy_config_core_v3_http_uri_proto_rawDesc = "" +
	...
	"\x12http_upstream_type\x12\x03\xf8B\x01B\x90\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"\"io.envoyproxy.envoy.config.core.v3B\fHttpUriProtoP\x01ZRgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/core/v3;corev3b\x06proto3"
