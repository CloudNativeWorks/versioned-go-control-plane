...
const file_envoy_config_core_v3_udp_socket_config_proto_rawDesc = "" +
	...
	"\n" +
	"prefer_gro\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\tpreferGroB\x98\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"\"io.envoyproxy.envoy.config.core.v3B\x14UdpSocketConfigProtoP\x01ZRgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/core/v3;corev3b\x06proto3"
