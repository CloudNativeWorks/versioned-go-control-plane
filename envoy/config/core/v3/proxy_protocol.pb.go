...
const file_envoy_config_core_v3_proxy_protocol_proto_rawDesc = "" +
	...
	"\rPerHostConfig\x12=\n" +
	"\n" +
	"added_tlvs\x18\x01 \x03(\v2\x1e.envoy.config.core.v3.TlvEntryR\taddedTlvsB\x96\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"\"io.envoyproxy.envoy.config.core.v3B\x12ProxyProtocolProtoP\x01ZRgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/core/v3;corev3b\x06proto3"
