...
const file_envoy_config_core_v3_extension_proto_rawDesc = "" +
	...
	"\"io.envoyproxy.envoy.config.core.v3B\x0eExtensionProtoP\x01ZBgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/core/v3;corev3b\x06proto3"
