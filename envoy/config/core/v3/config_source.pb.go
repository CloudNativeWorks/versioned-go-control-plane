...
const file_envoy_config_core_v3_config_source_proto_rawDesc = "" +
	...
	"\"io.envoyproxy.envoy.config.core.v3B\x11ConfigSourceProtoP\x01ZBgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/config/core/v3;corev3b\x06proto3"
