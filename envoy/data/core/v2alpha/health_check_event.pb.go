...
const file_envoy_data_core_v2alpha_health_check_event_proto_rawDesc = "" +
	...
	"%io.envoyproxy.envoy.data.core.v2alphaB\x15HealthCheckEventProtoP\x01Z>github.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/core/v2alphab\x06proto3"
