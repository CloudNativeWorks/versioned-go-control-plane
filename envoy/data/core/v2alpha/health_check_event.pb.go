...
const file_envoy_data_core_v2alpha_health_check_event_proto_rawDesc = "" +
	...
	"\x04GRPC\x10\x02\x12\t\n" +
	"\x05REDIS\x10\x03B\x98\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"%io.envoyproxy.envoy.data.core.v2alphaB\x15HealthCheckEventProtoP\x01ZNgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/core/v2alphab\x06proto3"
