...
const file_envoy_data_core_v3_tlv_metadata_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\fR\x05value:\x028\x01B\x90\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	" io.envoyproxy.envoy.data.core.v3B\x10TlvMetadataProtoP\x01ZPgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/core/v3;corev3b\x06proto3"
