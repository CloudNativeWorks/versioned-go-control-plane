...
const file_envoy_data_tap_v2alpha_transport_proto_rawDesc = "" +
	...
	"$io.envoyproxy.envoy.data.tap.v2alphaB\x0eTransportProtoP\x01Z=github.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/tap/v2alphab\x06proto3"
