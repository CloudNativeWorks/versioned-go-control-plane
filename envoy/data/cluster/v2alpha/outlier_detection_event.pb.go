...
const file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDesc = "" +
	...
	"\aUNEJECT\x10\x01B\xc0\x01\xf2\x98\xfe\x8f\x05\x17\x12\x15envoy.data.cluster.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"(io.envoyproxy.envoy.data.cluster.v2alphaB\x1aOutlierDetectionEventProtoP\x01ZQgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/cluster/v2alphab\x06proto3"
