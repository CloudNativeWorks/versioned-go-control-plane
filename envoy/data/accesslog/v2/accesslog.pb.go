...
const file_envoy_data_accesslog_v2_accesslog_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x9d\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"%io.envoyproxy.envoy.data.accesslog.v2B\x0eAccesslogProtoP\x01ZZgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/accesslog/v2;accesslogv2b\x06proto3"
