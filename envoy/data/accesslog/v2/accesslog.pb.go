...
const file_envoy_data_accesslog_v2_accesslog_proto_rawDesc = "" +
	...
	"%io.envoyproxy.envoy.data.accesslog.v2B\x0eAccesslogProtoP\x01ZJgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/accesslog/v2;accesslogv2b\x06proto3"
