...
const file_envoy_data_accesslog_v3_accesslog_proto_rawDesc = "" +
	...
	"%io.envoyproxy.envoy.data.accesslog.v3B\x0eAccesslogProtoP\x01ZJgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/accesslog/v3;accesslogv3b\x06proto3"
