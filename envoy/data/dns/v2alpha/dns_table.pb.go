...
const file_envoy_data_dns_v2alpha_dns_table_proto_rawDesc = "" +
	...
	"\n" +
	"answer_ttl\x18\x03 \x01(\v2\x19.google.protobuf.DurationB\b\xfaB\x05\xaa\x01\x02*\x00R\tanswerTtlB\x90\x01\xba\x80\xc8\xd1\x06\x04\b\x01\x10\x01\n" +
	"$io.envoyproxy.envoy.data.dns.v2alphaB\rDnsTableProtoP\x01ZMgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/data/dns/v2alphab\x06proto3"
