...
const file_envoy_admin_v2alpha_tap_proto_rawDesc = "" +
	...
	"\n" +
	"tap_config\x18\x02 \x01(\v2$.envoy.service.tap.v2alpha.TapConfigB\b\xfaB\x05\x8a\x01\x02\x10\x01R\ttapConfigB\x83\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"!io.envoyproxy.envoy.admin.v2alphaB\bTapProtoP\x01ZJgithub.com/CloudNativeWorks/versioned-go-control-plane/envoy/admin/v2alphab\x06proto3"
