...
const file_envoy_admin_v3_config_dump_shared_proto_rawDesc = "" +
	...
	"\x1cio.envoyproxy.envoy.admin.v3B\x15ConfigDumpSharedProtoP\x01Z=github.com/CloudNativeWorks/versioned-go-control-plane/envoy/admin/v3;adminv3b\x06proto3"
